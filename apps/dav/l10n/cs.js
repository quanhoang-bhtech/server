OC.L10N.register(
    ...
    "Expected filesize of %1$s but read (from xD Drive client) and wrote (to xD Drive storage) %2$s. Could either be a network problem on the sending side or a problem writing to the storage on the server side." : "Očekávána velikost souboru %1$s, ale čtení (z xD Drive klienta) a zápis (na xD Drive úložiště) %2$s. Mohlo by se jednat buď o problém na síti na odesílající straně, nebo o problém se zápisem na úložiště na straně serveru.",
