OC.L10N.register(
    ...
    "Expected filesize of %1$s but read (from xD Drive client) and wrote (to xD Drive storage) %2$s. Could either be a network problem on the sending side or a problem writing to the storage on the server side." : "Oczekiwany rozmiar pliku to %1$s, lecz odczytano (z klienta xD Drive) i zapisano (do pamięci xD Drive) %2$s. Może to być problem z siecią po stronie wysyłającej lub problem z zapisem do pamięci po stronie serwera.",
