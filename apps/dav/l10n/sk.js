OC.L10N.register(
    ...
    "Expected filesize of %1$s but read (from xD Drive client) and wrote (to xD Drive storage) %2$s. Could either be a network problem on the sending side or a problem writing to the storage on the server side." : "Očakávaná veľkosť súboru je %1$s, ale prečítalo sa (z klienta xD Drive) a zapísalo sa (do úložiska xD Drive) %2$s. Môže ísť o problém so sieťou na strane odosielania alebo problém so zápisom do úložiska na strane servera.",
