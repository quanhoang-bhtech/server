OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "Не можа да се установи федерирано споделяне, изглежда, че сървърът за федериране е твърде стар (xD Drive <= 9).",
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "Споделете с мен, чрез моя #xD-Drive Federated Cloud ID - %s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "Споделете с мен, чрез моя #xD-Drive Federated Cloud ID",
    "Sharing" : "Споделяне",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Можете да споделяте с всеки, който използва сървър xD Drive или други сървъри и услуги, съвместими с Open Cloud Mesh (OCM)! Просто поставете техния идентификатор за Федериран облак в диалоговия прозорец за споделяне. Изглежда като person@cloud.example.com",
    ...
    "Share with me via xD Drive" : "Споделете с мен, чрез xD Drive",
    "HTML Code:" : "HTML код:",
    "Share with me through my #xD-Drive Federated Cloud ID, see {url}" : "Споделете с мен чрез моя #xD-Drive Federated Cloud ID, вижте {url}",
