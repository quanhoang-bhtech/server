OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "Ne povis fari federan kunhavon, ŝajnas, ke la servilo federota estas tro malnova (xD Drive ⩽ 9).",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Vi povas kunhavigi kun iu, kiu uzas xD Drive aŭ aliaj serviloj kaj servoj kungruaj kun „Open Cloud Mesh (OCM)“! Entajpu simple lian aŭ ŝian federnuban identigilon en la kunhaviga dialogo. Federnuba identigilo similas al persono@nubo.example.com",
    ...
    "Share with me via xD Drive" : "Kunhavigi kun mi per xD Drive",
    "HTML Code:" : "HTML-kodo:",
