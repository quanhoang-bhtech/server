OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "Nije moguće uspostaviti udruženo dijeljenje, čini se da je poslužitelj s kojim se udružuje prestar (xD Drive <= 9).",
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "Dijeli sa mnom putem mog #ID-ja udruženog oblaka xD Drive, pogledajte %s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "Dijeli sa mnom putem mog #ID-ja udruženog oblaka xD Drive",
    "Sharing" : "Dijeljenje",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Možete dijeliti sa svima koji upotrebljavaju poslužitelj xD Drive ili druge poslužitelje i usluge kompatibilne s Open Cloud Mesh (OCM)! Samo unesite njihov Federated Cloud ID u dijaloški okvir za dijeljenje. Primjerice: osoba@cloud.example.com",
    ...
    "Share with me via xD Drive" : "Dijelite sa mnom putem xD Drive",
    "HTML Code:" : "HTML kod:",
