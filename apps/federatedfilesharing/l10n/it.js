OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "Impossibile stabilire una condivisione federata, sembra che il server da federare sia troppo datato (xD Drive  <= 9).",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Puoi condividere con chiunque utilizzi server xD Drive o altri server e servizi Open Cloud Mesh (OCM) compatibili. Ti basta inserire il loro ID di cloud federata nella finestra di condivisione. Assomiglia a persona@cloud.esempio.com ",
    ...
    "Share with me via xD Drive" : "Condividi con me tramite xD Drive",
