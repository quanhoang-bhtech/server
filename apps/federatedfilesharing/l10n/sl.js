OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "Zvezne povezave za souporabo ni mogoče ustvariti. Kaže, da je podana zahteva za povezavo z nepodprto staro različico oblaka (Nextzcloud ≤ 9).",
    ...
    "Share with me through my #xD-Drive Federated Cloud ID, see %s" : "Omogoči souporabo z #Določilom ID zveznega oblaka xD Drive; več na %s",
    "Share with me through my #xD-Drive Federated Cloud ID" : "Omogoči souporabo z #Določilom ID zveznega oblaka xD Drive",
    "Sharing" : "Souporaba",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "Souporaba različnih predmetov je mogoča s komerkoli, ki uporablja strežnik xD Drive oziroma katerikoli strežnik, skladen s storitvami Open Cloud Mesh (OCM). Vpisati je treba zgolj njihov zvezni naslov ID v polje souporabe, ki je zapisano v obliki oseba@domena-oblaka.si oziroma oseba@domena.si/oblak.",
    ...
    "Share with me via xD Drive" : "Omogoči souporabo z oblaka xD Drive",
    "HTML Code:" : "Koda HTML:",
