OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "Birleşik bir paylaşım oluşturulamadı. Birleşik çalışılacak sunucunun sürümü çok eski gibi görünüyor (xD Drive <= 9).",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "xD Drive ya da Open Cloud Mesh (OCM) ile uyumlu sunucu ve hizmetler ile paylaşım yapılabilir. Paylaşım penceresine person@cloud.example.com gibi Birleşik Bulut Kodunu yazmanız yeterlidir.",
    ...
    "Share with me via xD Drive" : "Benimle xD Drive üzerinden paylaşın",
    "HTML Code:" : "HTML kodu:",
