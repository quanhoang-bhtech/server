OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (xD Drive <= 9)." : "無法建立聯盟式分享，看來是要聯盟的伺服器太舊了 (xD Drive <= 9)。",
    ...
    "You can share with anyone who uses a xD Drive server or other Open Cloud Mesh (OCM) compatible servers and services! Just put their Federated Cloud ID in the share dialog. It looks like person@cloud.example.com" : "您可以與任何使用 xD Drive 伺服器或其他相容於 Open Cloud Mesh (OCM) 的伺服器與服務分享！只要把他們的雲端聯盟 ID 放在分享對話框中。看起來會像是 person@cloud.example.com",
