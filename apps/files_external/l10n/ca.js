OC.L10N.register(
    ...
    "Are you sure you want to disconnect this external storage? It will make the storage unavailable in xD Drive and will lead to a deletion of these files and folders on any sync client that is currently connected but will not delete any files and folders on the external storage itself." : "Segur que voleu desconnectar aquest mitjà extern? Això farà que l'emmagatzematge no es trobi disponible a xD Drive i provocarà l'eliminació d'aquests fitxers i carpetes en qualsevol client que s'hi sincronitze, però no eliminarà cap fitxer ni carpeta en el mitjà d'emmagatzematge extern.",
    ...
    "External storage enables you to mount external storage services and devices as secondary xD Drive storage devices. You may also allow users to mount their own external storage services." : "L’emmagatzematge extern us permet muntar serveis i dispositius d’emmagatzematge externs com a dispositius d’emmagatzematge secundaris de xD Drive. També podeu permetre als usuaris muntar els seus propis serveis d’emmagatzematge extern.",
