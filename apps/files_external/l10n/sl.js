OC.L10N.register(
    ...
    "Are you sure you want to disconnect this external storage? It will make the storage unavailable in xD Drive and will lead to a deletion of these files and folders on any sync client that is currently connected but will not delete any files and folders on the external storage itself." : "Ali ste prepričani, da želite odklopiti to mesto zunanje shrambe? Odklopljena shramba ni na voljo v oblaku xD Drive, mape in datoteke pa ne bodo dostopne in ne usklajevanje. Datoteke zunanje shrambe ostanejo nedotaknjene.",
    ...
    "External storage enables you to mount external storage services and devices as secondary xD Drive storage devices. You may also allow users to mount their own external storage services." : "Zunanja shramba omogoča uporabo in priklop zunanjih storitev za shranjevanje in povezane naprave kot dodatna skladišča xD Drive. Dovoliti je mogoče tudi priklapljanje uporabniških zunanjih shramb v skupno okolje.",
