OC.L10N.register(
    ...
    "Are you sure you want to disconnect this external storage? It will make the storage unavailable in xD Drive and will lead to a deletion of these files and folders on any sync client that is currently connected but will not delete any files and folders on the external storage itself." : "您確定要斷開這個外部儲存空間嗎？這將讓該儲存空間無法在 xD Drive 中使用，並將會在目前連線的任何同步客戶端上刪除這些檔案與資料夾，但不會刪除外部儲存空間本身的任何檔案與資料夾。",
    ...
    "External storage enables you to mount external storage services and devices as secondary xD Drive storage devices. You may also allow users to mount their own external storage services." : "外部儲存空間讓您可以掛載外部儲存空間服務與裝置來作為次要的 xD Drive 儲存裝置。您也可以允許使用者掛載他們自己的儲存服務。",
    "Folder name" : "資料夾名稱",
    "Authentication" : "驗證",
    "Configuration" : "設定",
    "Available for" : "可用的",
