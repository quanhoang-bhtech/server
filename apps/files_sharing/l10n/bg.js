OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Неуспешно добавяне на публичната връзка към вашия xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Споделянето %s на изпращането на паролата от xD Drive Talk не бе успешно, тъй като xD Drive Talk не е активирано",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "„Изпращането на паролата от xD Drive Talk“ за споделяне на файл или папка не беше успешно, тъй като xD Drive Talk не е активиран.",
    ...
    "Accept" : "Приемане",
    "Reject" : "Откажи",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Приложението позволява споделянето на файлове с xD Drive. Администраторът може да ограничи споделянето само за определени групи. Потретилите с права ще могат да споделят файлове и папки с други потребители и групи от xD Drive. За споделяне с потребители извън Nextloud администраторът трябва да активира функционалността за споделяне с връзка. Администратора може да наложи ползването на пароли, валидност, споделяне с връзка от сървър към сървър и споделяне от мобилни устройства.\nИзключването на функционалността ще прекрати споделени файлове и папки от сървъра (за потребители, клиенти за синхронизиране и мобилни приложения). Подробна информация ще намерите в документацията на xD Drive.",
    "Sharing" : "Споделяне",
    ...
    "Add to your xD Drive" : "Добавете към xD Drive",
