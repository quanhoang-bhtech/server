OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "No s'ha pogut afegir l'enllaç públic al vostre xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "No s'ha pogut compartir %s enviant la contrasenya per xD Drive Talk perquè xD Drive Talk no està activat",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "No s'ha pogut “Enviar la contrasenya per xD Drive Talk/Parla” per compartir un fitxer o una carpeta perquè xD Drive Talk/Parla no està habilitat.",
    ...
    "Accept" : "Accepta",
    "Reject" : "Rebutja",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Aquesta aplicació permet als usuaris compartir fitxers a xD Drive. Si està activat, l'administrador pot triar quins grups poden compartir fitxers. Els usuaris aplicables poden compartir fitxers i carpetes amb altres usuaris i grups de xD Drive. A més, si l’administrador activa la funció d’enllaç compartit, es pot fer servir un enllaç extern per compartir fitxers amb altres usuaris fora de xD Drive. Els administradors també poden aplicar contrasenyes, dates de caducitat i activar la compartició de servidor a servidor mitjançant enllaços compartits, així com la compartició de dispositius mòbils.\nDesactivant la funcionalitat suprimirà els fitxers compartits i les carpetes del servidor per a tots els destinataris compartits i també per als clients de sincronització i les aplicacions per a mòbils. Podeu trobar més informació a la documentació de xD Drive.",
    ...
    "Add to your xD Drive" : "Afegiu al vostre xD Drive",
