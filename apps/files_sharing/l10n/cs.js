OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Nepodařilo se přidání veřejného odkazu do xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Sdílení %s posláním hesla přes xD Drive Talk se nezdařilo, protože xD Drive Talk není zapnutý",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "„Zaslání hesla prostřednictvím xD Drive Talk“ pro sdílení souboru či složky se nezdařilo protože xD Drive Talk není zapnuté.",
    "shared by %s" : "sdílí %s",
    ...
    "Accept" : "Přijmout",
    "Reject" : "Odmítnout",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Tato aplikace uživatelům umožňuje sdílet soubory v rámci xD Drive. Pokud je zapnutá, správce může zvolit které skupiny mohou sdílet soubory. Pověření uživatelé pak mohou sdílet soubory a složky s ostatními uživateli a skupinami v rámci xD Drive. Krom toho, pokud správce zapne funkci odkazu sdílení, je možné sdílet soubory i s uživateli mimo xD Drive a to pomocí externího odkazu. Správci také mohou vynutit používání hesel, datumů expirace a zapnout sdílení server-server pomocí sdílecích odkazů. Stejně tak sdílení z mobilních zařízení.\nVypnutí této funkce odebere sdílené soubory a složky na server pro všechny příjemce sdílení a také na synchronizačních klientech a mobilních aplikacích. Více informací je k dispozici v dokumentaci k xD Drive.",
    "Sharing" : "Sdílení",
    ...
    "Add to your xD Drive" : "Přidat do xD Drive",
