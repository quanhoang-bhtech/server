OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Fehler beim Hinzufügen des öffentlichen Links zu deiner xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "%s Freigeben: Senden des Passwortes über xD Drive Talk gescheitert, da xD Drive Talk nicht verfügbar ist",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"Senden des Passwortes über xD Drive Talk\" zum Teilen einer Datei  gescheitert, da xD Drive Talk nicht verfügbar ist.",
    ...
    "Accept" : "Akzeptieren",
    "Reject" : "Ablehnen",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Diese App ermöglicht es Nutzern, Dateien innerhalb von xD Drive freizugeben. Bei aktivierter App kann der Administrator einstellen, welchen Gruppen das Freigeben von Dateien erlaubt ist.. Der zugelassene Nutzer kann dann Dateien und Ordner für andere Gruppen und Nutzer innerhalb der xD Drive freigeben. Darüberhinaus kann der Administrator die Link-Teilen Funktion freigeben, mit der ein externer Link um Dateien für Nutzer außerhalb der xD Drive freizugeben. Schließlich kann der Administrator noch Passwortrichtlinien und Ablaufzeiträume vorgeben sowie das Freigeben von Mobilgeräten ermöglichen.\nDas Ausschalten dieser App entfernt die bis dahin erstellten Freigaben für alle Empfänger wie auch für die Sync-Clients und die Apss für Mobilgeräte. Weitere Informationen können in der xD Drive-Dokumentation abgerufen werden.",
    "Sharing" : "Teilen",
    ...
    "Add to your xD Drive" : "Zu deiner xD Drive hinzufügen",
