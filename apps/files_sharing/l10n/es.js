OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "No se ha podido añadir el enlace público a tu xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Compartir %s enviando la contraseña por xD Drive Talk ha falllado porque xD Drive Talk no está activado",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"El envío de la contraseña por xD Drive Talk\" para compartir un archivo o carpeta falló porque xD Drive Talk no está habilitado.",
    ...
    "Accept" : "Aceptar",
    "Reject" : "Rechazar",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Esta aplicación permite a los usuarios compartir archivos dentro de xD Drive. Si se activa, el administrador puede elegir qué grupos pueden compartir archivos. Los usuarios aplicables pueden entonces compartir archivos y carpetas con otros usuarios y grupos dentro de xD Drive. Además, si el administrador activa la característica de enlace compartido, se puede usar un enlace externo para compartir archivos con otros usuarios fuera de xD Drive. Los administradores pueden obligar a usar contraseñas o fechas de caducidad y activar el compartir de servidor a servidor vía enlaces compartidos, así como compartir desde dispositivos móviles.\nQuitar esta característica elimina los archivos compartidos y las carpetas en el servidor, para todos los receptores, y también los clientes de sincronización y móviles. Más información disponible en la Documentación de xD Drive.",
    "Sharing" : "Compartir",
    ...
    "Add to your xD Drive" : "Añadir a tu xD Drive",
