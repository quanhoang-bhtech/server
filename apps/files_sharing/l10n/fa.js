OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "خطا در افزودن ادرس عمومی به نکس کلود شما",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : ".اشتراک‍‍‍%s ارسال رمز عبور توسط xD Drive Talk به دلیل فعال نشدن xD Drive Talk انجام نشد.",
    ...
    "Accept" : "پذیرفتن",
    "Reject" : "رد کردن",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "این برنامه کاربران را قادر می سازد تا پرونده ها را در xD Drive به اشتراک بگذارند. در صورت فعال بودن ، سرپرست می تواند انتخاب کند که گروه ها می توانند فایل ها را به اشتراک بگذارند. کاربران قابل استفاده سپس می توانند فایلها و پوشه ها را با سایر کاربران و گروه های موجود در xD Drive به اشتراک بگذارند. علاوه بر این ، اگر سرپرست ویژگی پیوند اشتراک را فعال کند ، می توان از یک لینک خارجی برای به اشتراک گذاری فایلها با سایر کاربران خارج از xD Drive استفاده کرد. Admins همچنین می تواند رمزهای عبور ، تاریخهای انقضا را اعمال کرده و سرور را قادر به اشتراک گذاری سرور از طریق پیوندهای اشتراک گذاری و همچنین به اشتراک گذاری از دستگاههای تلفن همراه کند.\nخاموش کردن ویژگی ، پرونده ها و پوشه های مشترک را در سرور برای همه گیرندگان اشتراک و همچنین در کلاینت های همگام سازی و برنامه های تلفن همراه حذف می کند. اطلاعات بیشتر در مستندات xD Drive در دسترس است.",
    ...
    "Add to your xD Drive" : "به نکست‌کلود خود اضافه کنید",
