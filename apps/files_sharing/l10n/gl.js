OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Non foi posíbel engadir a ligazón pública ao seu xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Compartir %s enviando o contrasinal por xD Drive Talk fallou porque xD Drive Talk non está activado",
    ...
    "Accept" : "Aceptar",
    "Reject" : "Rexeitar",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Esta aplicación permítelle aos usuarios compartir ficheiros dentro de xD Drive. Se o activa, o administrador pode escoller que grupos poden compartir fiheiros. Os usuarios implicados poderán compartir ficheiros e cartafoles con outros usuarios e grupos dentro do xD Drive. Ademais, se o administrador activa a característica de ligazón compartida, pode empregarse unha ligazón externa para compartir ficheiros con outros usuarios fora do xD Drive. Os administradores poden obrigar a usar contrasinais ou datas de caducidade  e activar a compartición de servidor a servidor mediante ligazóns compartidas, así como compartir dende dispositivos móbiles.\nDesactivar esta característica elimina os ficheiros compartidos e os cartafoles no servidor, para todos los receptores, e tamén dos clientes de sincronización e móbiles. Ten dispoñíbel máis información na documentación do xD Drive.",
    "Sharing" : "Compartindo",
    ...
    "Add to your xD Drive" : "Engadir ao seu xD Drive",
