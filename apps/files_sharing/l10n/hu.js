OC.L10N.register(
    ...
    "Accept" : "Elfogadás",
    "Reject" : "Elutasítás",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Ez az alkalmazás lehetővé teszi a felhasználók számára a fájlok megosztását a xD Drive belül. Amennyiben engedélyezve van, a rendszergazda kiválaszthatja, hogy mely csoportok oszthassanak meg fájlokat. Az érintett felhasználók ezután megoszthatják a fájlokat és mappákat más felhasználókkal és csoportokkal a xD Drive belül. Ezenkívül, ha a rendszergazda engedélyezi a megosztás hivatkozással funkciót, akkor egy külső hivatkozás segítségével fájlokat oszthat meg más felhasználókkal a xD Drive kívül. A rendszergazdák kikényszeríthetik a jelszavakat, a lejárati dátumokat, és engedélyezhetik a megosztási hivatkozásokkal történő kiszolgálók közötti, valamint a mobileszközökön történő megosztást.\nA funkció kikapcsolása eltávolítja a megosztott fájlokat és mappákat a kiszolgálóról az összes megosztott címzett, valamint a szinkronizálási kliensek és mobilalkalmazások számára. További információ a xD Drive dokumentációjában található.",
    "Sharing" : "Megosztás",
    ...
    "Add to your xD Drive" : "Hozzáadás a xD Driveához",
