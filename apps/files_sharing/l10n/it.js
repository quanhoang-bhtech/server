OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Aggiunta del collegamento pubblico al tuo xD Drive non riuscita",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "La condivisione di %s tramite invio della password da xD Drive Talk non è  riuscito poiché xD Drive Talk non è abilitato",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"Invio della password da xD Drive Talk\" per condividere un file o una cartella non è riuscito poiché xD Drive Talk non è attivato.",
    ...
    "Accept" : "Accetta",
    "Reject" : "Rifiuta",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Questa applicazione consente agli utenti di condividere file all'interno di xD Drive. Se abilitata, l'amministratore può scegliere quali gruppi possono condividere file. Gli utenti ai quali si applica possono quindi condividere file e cartelle con altri utenti e gruppi all'interno di xD Drive. In aggiunta, se l'amministratore abilita la funzionalità dei collegamenti di condivisione, un collegamento esterno può essere utilizzato per condividere file con altri utenti all'esterno di xD Drive. Gli amministratori possono inoltre forzare le password, le date di scadenza e abilitare la condivisione tra server tramite collegamenti di condivisione, così come la condivisione da dispositivi mobili.\nLa disattivazione della funzionalità rimuove i file e le cartelle condivisi sul server per tutti i destinatari della condivisione, e anche sui client di sincronizzazione e sulle applicazioni mobili. Altre informazioni sono disponibili nella documentazione di xD Drive.",
    ...
    "Add to your xD Drive" : "Aggiungi al tuo xD Drive",
