OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Nepavyko pridėti viešosios nuorodos į jūsų xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Nepavyko išsiųsti slaptažodžio bendrinimui %s panaudojant xD Drive Talk, kadangi xD Drive Talk neįjungtas ",
    ...
    "Accept" : "Priimti",
    "Reject" : "Atmesti",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : " Ši programa leidžia vartotojams dalytis failais „xD Drive“ informacinės sistemos platformoje. Sistemos administratorius gali pasirinkti, kurios naudotojų grupės gali atlikti failų bendrinimus. Tuomet atitinkami naudotojau gali dalintis failais ir aplankais su kitais „xD Drive“ naudotojais ir jų grupėmis. Jei administratorius įjungia bendrinimo nuorodos funkcionalumą, išorinė nuoroda gali būti naudojama bendrinant failus su išoriniais naudotojais už „xD Drive“ ribų. Administratoriai taip pat gali nustatyti slaptažodžius, bendrinimo galiojimo datas ir įjungti serveris serveriui bendrinimą nuorodomis, taip pat bendrinimasi iš mobiliųjų įrenginių.\nIšjungus šią funkciją, bendrinami failai ir aplankai yra pašalinami serveryje visiems bendrinimo gavėjams, taip pat sinchronizavimo klientams ir mobilioms programoms. Daugiau informacijos rasite „xD Drive“ dokumentacijoje. ",
    "Sharing" : "Bendrinimas",
    ...
    "Add to your xD Drive" : "Pridėti į savo xD Drive",
