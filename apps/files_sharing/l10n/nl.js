OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Kon de openbare link niet aan je xD Drive toevoegen",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Delen %s versturen van het wachtwoord via xD Drive Talk is mislukt omdat xD Drive Talk niet is ingeschakeld",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"Het wachtwoord verzenden via xD Drive Talk\" voor het delen van een bestand of map is mislukt omdat xD Drive Talk niet is ingeschakeld.",
    ...
    "Accept" : "Accepteren",
    "Reject" : "Afwijzen",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Met deze applicatie kunnen gebruikers bestanden delen binnen xD Drive. Indien ingeschakeld, kan de beheerder kiezen welke groepen bestanden kunnen delen. De betreffende gebruikers kunnen vervolgens bestanden en mappen delen met andere gebruikers en groepen binnen xD Drive. Als de beheerder de functie voor het delen van koppelingen inschakelt, kan ook een externe koppeling worden gebruikt om bestanden te delen met andere gebruikers buiten xD Drive. Beheerders kunnen ook wachtwoorden en vervaldatums afdwingen en delen van server-naar-server mogelijk maken via koppelingslinks en evenals delen vanaf mobiele apparaten.\nAls je de functie uitschakelt, worden gedeelde bestanden en mappen op de server verwijderd voor alle ontvangers van shares, en ook voor de synchronisatieclients en mobiele apps. Meer informatie is beschikbaar in de xD Drive-documentatie.",
    "Sharing" : "Delen",
    ...
    "Add to your xD Drive" : "Toevoegen aan je xD Drive",
