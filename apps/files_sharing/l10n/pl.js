OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Nie udało się dodać linku publicznego do xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Udostępnienie %s wysyłanego hasła przez xD Drive Talk nie powiodło się, ponieważ xD Drive Talk nie jest włączony",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"Wysyłanie hasła przez xD Drive Talk\" w celu udostępnienia pliku lub katalogu nie powiodło się, ponieważ usługa xD Drive Talk jest wyłączona.",
    ...
    "Accept" : "Akceptuj",
    "Reject" : "Odrzuć",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Aplikacja umożliwia użytkownikom udostępnianie plików w xD Drive. Jeśli ta opcja jest włączona, administrator może wybrać, które grupy mogą udostępniać pliki. Odpowiedni użytkownicy mogą następnie udostępniać pliki i katalogi innym użytkownikom i grupom w xD Drive. Ponadto, jeśli administrator włączy funkcję udostępniania przez link, można użyć zewnętrznego linku do udostępniania plików innym użytkownikom poza xD Drive. Administratorzy mogą również wymuszać hasła, daty wygaśnięcia i udostępnienia między serwerami za pośrednictwem linków udostępnienia, a także udostępnienia z urządzeń mobilnych.\nWyłączenie tej funkcji powoduje usunięcie udostępnionych plików i katalogów na serwerze dla wszystkich odbiorców, a także klientów synchronizacji i aplikacji mobilnych. Więcej informacji można znaleźć w dokumentacji xD Drive.",
    ...
    "Add to your xD Drive" : "Dodaj do swojego xD Drive",
