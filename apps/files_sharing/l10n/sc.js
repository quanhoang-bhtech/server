OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "No at fatu a agiùnghere su ligòngiu pùblicu in xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Sa cumpartzidura de%scun s'imbiu de sa crae dae xD Drive Talk est faddida ca xD Drive Talk est disativadu",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"S'imbiu de sa crae dae xD Drive Talk\" pro cumpartzire un'archìviu o cartella est faddida ca xD Drive Talk est disativadu.",
    ...
    "Accept" : "Atzeta",
    "Reject" : "Refuda",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Custa aplicatzione permitit a is utentes de cumpartzire archìvios in xD Drive. Si ativada, s'amministratzione podet seberare cales grupos podent cumpartzire archìvios. Is utèntzias seberadas podent cumpartzire archìvios e cartellas cun àteras utèntzias e grupos de xD Drive. In prus, si s'amministratzione ativat sa funtzionalidade de is ligòngios de cumpartzidura, faghet a impreare unu ligòngiu esternu pro cumpartzire archìvios cun àtere in foras dae xD Drive. S'amministratzione podet puru afortigare craes, datas de iscadèntzia, e ativare sa cumpartzidura intre serbidores tràmite ligòngios de cumpartzidura, e fintzas sa cumpartzidura dae dispositivos mòbiles.\nDisativende sa funtzionalidade s'ant a bogare archìvios e is cartellas cumpartzidas in su serbidore pro totu is persones retzidoras de sa cumpartzidura, e puru in is clientes de sincronizatzione e in is aplicatziones mòbiles. Àteras informatziones a disponimentu in sa documentatzione de xD Drive.",
    ...
    "Add to your xD Drive" : "Agiunghe a su xD Drive tuo",
