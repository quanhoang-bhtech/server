OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Pridanie verejne dostupného odkazu do vášho xD Drive zlyhalo",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Zdieľanie %s odoslaním hesla cez xD Drive Talk zlyhalo, pretože xD Drive Talk nie je zapnutý",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"Odoslanie hesla cez xD Drive Talk\" pre zdieľanie súboru alebo priečinka zlyhalo, pretože xD Drive Talk nie je zapnutý.",
    ...
    "Accept" : "Prijať",
    "Reject" : "Odmietnuť",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Táto aplikácia umožňuje používateľom si navzájom sprístupňovať súbory v rámci xD Drive. Ak je zapnutá, správca môže zvoliť, ktoré skupiny môžu súbory sprístupňovať ostatným. Poverení používatelia potom môžu tieto súbory sprístupňovať ostatným používateľom a skupinám v rámci xD Drive. Navyše, ak správca zapne funkciu sprístupňovania pomocou odkazu, je možné súbory sprístupňovať aj mimo xD Drive a to pomocou externého odkazu (linku). Správci tiež môžu vynútiť používanie hesiel, dátumov expirácie a zapnúť sprístupňovanie server-server pomocou zdieľaných odkazov. Rovnako aj sprístupňovanie z mobilných zariadení.\nVypnutím tejto funkcie odoberie sprístupnené súbory a priečinky na serveri pre všetkých príjemcov sprístupnenia a taktiež aj na synchronizovaných klientoch (napr. počítačová aplikácia xD Drive) a mobilných aplikáciách. Viac informácií je k dispozícii v dokumentácii xD Drive.",
    ...
    "Add to your xD Drive" : "Pridať do svojho xD Drive",
