OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Misslyckades skapa den offentliga delningslänken till ditt moln",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Dela %s och skicka lösenordet via xD Drive Talk går inte eftersom xD Drive Talk är inte aktiverad",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "\"Skicka lösenord via xD Drive Talk\" för att dela en fil eller mapp misslyckades eftersom xD Drive Talk inte är aktiverat.",
    ...
    "Accept" : "Acceptera",
    "Reject" : "Avvisa",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "Denna applikation gör det möjligt för användare att dela filer inom xD Drive. Om aktiverad kan administratören välja vilka grupper som kan dela filer. De tillämpliga användarna kan sedan dela filer och mappar med andra användare och grupper inom xD Drive. Dessutom, om administratören aktiverar funktionen dela länk, kan en extern länk användas för att dela filer med andra användare utanför xD Drive. Administratörer kan också tvinga lösenord, utgångsdatum och aktivera server till serverdelning via delningslänkar samt dela från mobila enheter.\nOm du stänger av funktionen tar du bort delade filer och mappar på servern för alla delmottagare och även på synkroniseringsklienterna och mobilapparna. Mer information finns i dokumentationen för xD Drive.",
    "Sharing" : "Delning",
    ...
    "Add to your xD Drive" : "Lägg till i molnet",
