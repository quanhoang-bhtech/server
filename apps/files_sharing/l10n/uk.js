OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "Не вдалося додати загальнодоступне посилання до вашого xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "Виникла помилка під час надання доступу до %s, оскільки xD Drive Talk не активний й відтак неможливо надіслати пароль.",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "Не вдалося надіслати пароль для спільного доступу до файлу чи каталогу з використанням xD Drive Talk, оскільки цей застосунок вимкнено.",
    ...
    "Add to your xD Drive" : "Додати до вашої хмари xD Drive",
