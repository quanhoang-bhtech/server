OC.L10N.register(
    ...
    "Failed to add the public link to your xD Drive" : "無法將公開連結加入您的 xD Drive",
    ...
    "Sharing %s sending the password by xD Drive Talk failed because xD Drive Talk is not enabled" : "因為未啟用 xD Drive Talk，因此透過 xD Drive Talk 傳送密碼分享 %s 失敗",
    ...
    "\"Sending the password by xD Drive Talk\" for sharing a file or folder failed because xD Drive Talk is not enabled." : "“通過 xD Drive Talk 發送密碼”共享檔案或資料夾失敗，因為 xD Drive Talk 未啟用。",
    "shared by %s" : "分享自 %s",
    ...
    "Accept" : "接受",
    "Reject" : "拒絕",
    "This application enables users to share files within xD Drive. If enabled, the admin can choose which groups can share files. The applicable users can then share files and folders with other users and groups within xD Drive. In addition, if the admin enables the share link feature, an external link can be used to share files with other users outside of xD Drive. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the xD Drive Documentation." : "該應用程序使用戶可以在xD Drive中共享檔案。如果啟用，管理員可以選擇可以共享文件的群組。然後，適用的用戶可以與xD Drive中的其他用戶和群組共享檔案和資料夾。此外，如果管理員啟用了共享連結功能，則可以使用外部連結與xD Drive之外的其他用戶分享檔案。管理員還可以實施密碼，有效期，並允許通過分享檔案進行伺服器到伺服器的分享以及從流動裝置進行分享。\n關閉此功能將刪除伺服器上所有分享收件人以及同步客戶端和流動應用程序上的分享了檔案和資料夾。xD Drive文檔中提供了更多信息。",
    "Sharing" : "分享",
    ...
    "Add to your xD Drive" : "加入到您的 xD Drive",
