OC.L10N.register(
    ...
    "Unlimited" : "Senlima",
    "Verifying" : "Kontrolado",
    "xD Drive settings" : "xD Drive-agordoj",
    "None" : "Nenio",
    ...
    "Remove" : "Forigi",
    "Disable" : "Malŝalti",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Tiu aplikaĵo ne postulas minimuman xD Drive-version. Tio estos eraro en la estonteco.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Tiu aplikaĵo ne postulas maksimuman xD Drive-version. Tio estos eraro en la estonteco.",
    ...
    "This app is supported via your current xD Drive subscription." : "Tiu aplikaĵo estas subtenita per via nuna xD Drive-abono.",
    "Supported" : "Subtenite",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "Okaze de perdo de aparato aŭ eliro de la organizaĵo, tio povas defore forviŝi la datumojn de xD Drive el ĉiuj aparatoj ligitaj per {userid}. Nur funkcias, se la aparatoj estas konektitaj  al interreto.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Tiu aplikaĵo ne kongruas kun via xD Drive-versio. Se vi daŭrigas, vi tamen povos instali ĝin, sed eble tiu aplikaĵo ne funkcios bone.",
    "Never" : "Neniam",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Kontrolu sekurecon de via servilo xD Drive pere de <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">nia sekureca ekzameno ↗</a>.",
    "Version" : "Versio",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Programita de la {communityopen}xD Drive-komunumo{linkclose}, la {githubopen}fontkodo{linkclose} havas {licenseopen}AGPL{linkclose}-permesilon.",
