OC.L10N.register(
    ...
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Esta aplicación no cuenta con una versión mínima de xD Drive asignada. Esto será un error en el futuro.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Esta aplicación no cuenta con una versión máxima de xD Drive asignada. Esto será un error en el futuro.",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Revise la seguridad de su xD Drive usando <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">el escáner de seguridad ↗</a>.",
    "Version" : "Versión",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Desarrollado por la  {communityopen}comunidad xD Drive {linkclose}, el {githubopen}código fuente {linkclose} está licenciado bajo  {licenseopen}AGPL{linkclose}.",
