OC.L10N.register(
    ...
    "xD Drive settings" : "Pengaturan xD Drive",
    "None" : "Tidak ada",
    ...
    "Remove" : "Hapus",
    "Disable" : "Nonaktifkan",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Aplikasi ini tidak mempunyai versi minimum xD Drive yang ditetapkan. Di masa depan nanti ini akan menjadi kesalahan.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Aplikasi ini tidak mempunyai versi maksimum xD Drive yang ditetapkan. Di masa depan nanti ini akan menjadi kesalahan.",
    ...
    "This app is supported via your current xD Drive subscription." : "Aplikasi ini didukung dengan langganan xD Drive Anda saat ini.",
    "Supported" : "Didukung",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Aplikasi ini tidak ditandai sebagai versi xD Drive Anda yang kompatibel. Jika Anda tetap ingin melanjutkannya, Anda tetap dapat memasang aplikasi. Catatan bahwa aplikasinya mungkin tidak akan berjalan seperti yang diharapkan.",
    "Never" : "Tidak pernah",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Cek keamanan xD Drive Anda dengan <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">pemindaian keamanan kami ↗</a>.",
    "Version" : "Versi",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Dikembangkan oleh {commmunityopen}komunitas xD Drive{linkclose}, {githubopen}sumber kode{linkclose} dilisensikan dibawah {licenseopen}AGPL{linkclose}.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Rilis komunitas xD Drive ini tidak didukung dan pemberitahuan instan tidak tersedia.",
