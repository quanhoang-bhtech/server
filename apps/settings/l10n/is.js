OC.L10N.register(
    ...
    "Verifying" : "Sannreyni",
    "xD Drive settings" : "Stillingar xD Drive",
    "None" : "Ekkert",
    ...
    "Remove" : "Fjarlægja",
    "Disable" : "Gera óvirkt",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Þetta vorrit er ekki með tiltekna neina lágmarksútgáfu xD Drive. Þetta mun gefa villu í framtíðinni.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Þetta vorrit er ekki með tiltekna neina hámarksútgáfu xD Drive. Þetta mun gefa villu í framtíðinni.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Þetta forrit er merkt sem ekki samhæft við þína útgáfu af xD Drive. Ef þú heldur áfram er mögulegt að þú getir samt sett forritið upp. En athugaðu þá að ekki er víst að forritið virki eins og skyldi.",
    "Never" : "Aldrei",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Athugaðu öryggi xD Drive-skýsins með <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">öryggisskönnun okkar ↗</a>.",
    "Version" : "Útgáfa",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Þróað af {communityopen}xD Drive samfélaginu{linkclose}, {githubopen}grunnkóðinn{linkclose} er gefinn út með {licenseopen}AGPL{linkclose} notkunarleyfinu.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Þessi samfélagsútgáfa xD Drive kemur ekki með neinni opinberri aðstoð og rauntímatilkynningar eru ekki til taks.",
