OC.L10N.register(
    ...
    "Remove" : "წაშლა",
    "Disable" : "გამორთვა",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "ეს აპლიკაცია არ საზღვრავს xD Drive-ის მინიმალურ ვერსიას. სამომავლოდ ეს ჩაითვლება შეცდომად.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "ეს აპლიკაცია არ საზღვრავს xD Drive-ის მაქსიმალურ ვერსიას. სამომავლოდ ეს ჩაითვლება შეცდომად.",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "განავითარა {communityopen}xD Drive საზოგადოებამ{linkclose}, {githubopen}კოდი{linkclose} is ლიცენზირებულია {licenseopen}AGPL ლიცენზიით{linkclose}.",
