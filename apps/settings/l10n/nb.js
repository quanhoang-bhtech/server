OC.L10N.register(
    ...
    "xD Drive settings" : "xD Drive innstillinger",
    "None" : "Ingen",
    ...
    "Remove" : "Fjern",
    "Disable" : "Deaktiver ",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Denne appen har ingen minimumversjon av xD Drive definert. Dette vil være en feil i fremtiden.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Denne appen har ingen høyeste versjon av xD Drive definert. Dette vil være en feil i fremtiden.",
    ...
    "This app is supported via your current xD Drive subscription." : "Denne appen er støttet av ditt nåværende xD Drive abonnement.",
    "Supported" : "Støttet",
    "Featured" : "Anbefalt",
    ...
    "Encryption alone does not guarantee security of the system. Please see documentation for more information about how the encryption app works, and the supported use cases." : "Krypteringen alene gir ikke noen garanti for systemets sikkerhet. Sjekk xD Drive-dokumentasjonen for mer informasjon om hvordan krypteringsappen virker, og de fungerende brukseksemplene.",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "I tilfelle man har mistet enheter eller skal ut av organisasjonen, så kan dette fjernslette xD Drive data fra alle enheter tilknyttet bruker med {userid}. Dette fungerer kun dersom enhetene er tilkoblet internett.",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Sjekk sikkerheten til din xD Drive med <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">vår sikkerhetsskanning ↗</a>.",
    "Version" : "Versjon",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Utviklet av {communityopen}xD Drive-miljøet{linkclose},  {githubopen}kildekoden{linkclose} er lisensiert under {licenseopen}AGPL{linkclose}.",
