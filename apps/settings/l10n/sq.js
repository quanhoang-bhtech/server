OC.L10N.register(
    ...
    "Remove" : "Hiqe",
    "Disable" : "Çaktivizoje",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Ky aplikacion nuk ka të caktuar një minimum versioni të xD Drive. Ky do të jetë një gabim në të ardhmen.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Ky aplikacion nuk ka të caktuar një maksimum versioni të xD Drive. Ky do të jetë një gabim në të ardhmen.",
    ...
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Zhvilluar nga {communityopen}komuniteti xD Drive {linkclose},  {githubopen}kodi i hapur{linkclose} iështë licensuar sipar {licenseopen}AGPL{linkclose}.",
