OC.L10N.register(
    ...
    "xD Drive settings" : "Некстклауд поставке",
    "None" : "Ништа",
    ...
    "Remove" : "Уклони",
    "Disable" : "Искључи",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Ова апликација нема дефинисану минималну верзију Некстклауда на којој ради. Ово ће у будућности постати грешка.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Ова апликација нема дефинисану максималну верзију Некстклауда на којој ради. Ово ће у будућности постати грешка.",
    ...
    "This app is supported via your current xD Drive subscription." : "Ова апликација је подржана са Вашом тренутном Некстклауд претплатом.",
    "Supported" : "Подржана",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "У случају изгубљеног уређаја или напуштања организације, овим се могу удаљено обрисати Некстклауд подаци са свих уређаја повезаних са налогом {userid}. Ради само ако је уређај повезан на интернет.",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ова апликација није означена као компатибилна са Вашом верзијом Некстклауда. Ако наставите, моћи ћете свеједно да инсталирате апликацију. Врло је могуће да апликација неће радити како је планирано.",
    "Never" : "Никад",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "Проверите безбедност Вашег Некстклауда на <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">нашем безбедоносном скенирању↗</a>.",
    "Version" : "Верзија",
    ...
    "Reasons to use xD Drive in your organization" : "Разлози да користите Некстклауд у Вашој организацији",
    "Developed by the {communityopen}xD Drive community{linkclose}, the {githubopen}source code{linkclose} is licensed under the {licenseopen}AGPL{linkclose}." : "Развијено од стране {communityopen}Некстклауд заједнице{linkclose}, {githubopen}изворни код{linkclose} је под {licenseopen}AGPL{linkclose} лиценцом.",
