OC.L10N.register(
    ...
    "Delete" : "ลบ",
    "Unlimited" : "ไม่จำกัด",
    "xD Drive settings" : "การตั้งค่า xD Drive",
    "None" : "ไม่มี",
    ...
    "This app is supported via your current xD Drive subscription." : "แอปนี้รองรับผ่านการเป็นสมาชิก xD Drive ปัจจุบันของคุณ",
    "Supported" : "รองรับ",
    "Featured" : "แนะนำ",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the xD Drive data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "ในกรณีที่อุปกรณ์สูญหายหรือออกจากองค์กร ตัวเลือกนี้สามารถล้างข้อมูล xD Drive จากทุกอุปกรณ์ที่เชื่อมโยงกับ {userid} จากระยะไกล การล้างข้อมูลจะทำงานเฉพาะเมื่ออุปกรณ์เชื่อมต่อกับอินเทอร์เน็ตเท่านั้น",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "แอปนี้ยังไม่ถูกระบุว่ารองรับกับรุ่น xD Drive ของคุณ หากคุณดำเนินการต่อ คุณจะสามารถติดตั้งแอปได้ แต่แอปอาจไม่ทำงานอย่างที่คาดหวังไว้",
    "Never" : "ไม่เคย",
    ...
    "Check the security of your xD Drive over <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">our security scan ↗</a>." : "ตรวจสอบความปลอดภัยของ xD Drive ของคุณผ่าน<a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">การสแกนความปลอดภัยของเรา ↗</a>",
    "Version" : "รุ่น",
    ...
    "Reasons to use xD Drive in your organization" : "เหตุผลที่ควรใช้ xD Drive ในองค์กรของคุณ",
