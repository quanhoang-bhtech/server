OC.L10N.register(
    ...
    "Remove" : "Xóa",
    "Disable" : "Tắt",
    "This app has no minimum xD Drive version assigned. This will be an error in the future." : "Ứng dụng này không có phiên bản xD Drive tối thiểu được chỉ định. Đây sẽ là một lỗi trong tương lai.",
    "This app has no maximum xD Drive version assigned. This will be an error in the future." : "Ứng dụng này không có phiên bản xD Drive tối đa được chỉ định. Đây sẽ là một lỗi trong tương lai.",
    ...
    "This app is supported via your current xD Drive subscription." : "Ứng dụng này được hỗ trợ thông qua thuê bao xD Drive hiện tại của bạn.",
    "Supported" : "Đã hỗ trợ",
    ...
    "This app is not marked as compatible with your xD Drive version. If you continue you will still be able to install the app. Note that the app might not work as expected." : "Ứng dụng này không được đánh dấu là tương thích với phiên bản xD Drive của bạn. Nếu bạn tiếp tục, bạn vẫn có thể cài đặt ứng dụng. Lưu ý rằng ứng dụng có thể không hoạt động như mong đợi.",
    "Never" : "Không bao giờ",
