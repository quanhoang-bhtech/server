OC.L10N.register(
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the xD Drive log file for more details." : "不能确定 cURL 的 TLS 版本是否已过时，因为在 HTTPS 请求 https://drive.xd-twin.io 时发生了错误。请检查 xD Drive 日志文件以获取更多信息。",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://drive.xd-twin.io Please check the xD Drive log file for more details." : "不能确定 cURL 的 TLS 版本是否已过时，因为在HTTPS请求 https://drive.xd-twin.io 时发生了错误。请检查 xD Drive 日志文件以了解详情。",
