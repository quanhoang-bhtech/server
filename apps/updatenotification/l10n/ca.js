OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Si us plau, comproveu els fitxers de registre del servidor i del xD Drive per detectar errors.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Mostra les notificacions d’actualització de xD Drive i proporciona l’SSO de l’actualitzador.",
    "Update" : "Actualitzar",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> aplicació no té cap versió compatible per a aquesta versió de xD Drive disponible.","<strong>%n</strong> aplicacions no tenen cap versió compatible per a aquesta versió de xD Drive disponible."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Totes</strong> les aplicacions tenen una versió compatible per aquesta versió de xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> aplicació no té cap versió compatible per a aquesta versió de xD Drive disponible","<strong>%n</strong> aplicacions no tenen cap versió compatible per a aquesta versió de xD Drive disponible"]
},
