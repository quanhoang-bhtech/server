OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Παρακαλούμε ελέγξτε για σφάλματα στα αρχεία ιστορικού του xD Drive και του διακομιστή σας.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Εμφανίζει ειδοποιήσεις ενημέρωσης για το xD Drive και παρέχει το SSO για την εφαρμογή ενημέρωσης.",
    "Update" : "Ενημέρωση",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> εφαρμογή δεν έχει διαθέσιμη συμβατή έκδοση για αυτήν την έκδοση xD Drive.","<strong>%n</strong> εφαρμογές δεν έχουν διαθέσιμη συμβατή έκδοση για αυτήν την έκδοση xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Όλες</strong> οι εφαρμογές έχουν διαθέσιμη συμβατή έκδοση για αυτήν την έκδοση xD Drive.",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> εφαρμογή δεν έχει διαθέσιμη συμβατή έκδοση για αυτήν την έκδοση xD Drive","<strong>%n</strong> εφαρμογές δεν έχουν διαθέσιμη συμβατή έκδοση για αυτήν την έκδοση xD Drive"]
},
