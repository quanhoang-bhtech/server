OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Por favor, revisa los archivos de registro de xD Drive y del servidor en busca de errores.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Muestra notificaciones de actualizaciones para Nexcloud y provee el SSO para el actualizador.",
    "Update" : "Actualizar",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> app no es compatible con esta versión de xD Drive.","<strong>%n</strong> apps no son compatibles con la versión de xD Drive.","<strong>%n</strong> apps no son compatibles con la versión de xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Todas</strong> las apps son compatibles con la versión de xD Drive disponible",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> app no es compatible con la versión de xD Drive disponible","<strong>%n</strong> apps no son compatibles con la versión de xD Drive disponible","<strong>%n</strong> apps no son compatibles con la versión de xD Drive disponible"]
},
