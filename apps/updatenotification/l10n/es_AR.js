OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Favor de verificar los archivos de bitacoras de xD Drive y del servidor por errores. ",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["La app <strong>%n</strong> no tiene una versión compatible con esta versión de xD Drive.","Las apps <strong>%n</strong> no tienen una versión compatible con esta versión de xD Drive.","Las apps <strong>%n</strong> no tienen una versión compatible con esta versión de xD Drive."]
},
