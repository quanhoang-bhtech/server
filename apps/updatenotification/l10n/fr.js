OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Veuillez vérifier les fichiers de log de xD Drive et du serveur pour les erreurs.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Affiche les notifications de mise à jour pour xD Drive et fournit l'authentification unique SSO pour le programme de mise à jour.",
    "Update" : "Mise à jour",
    ...
    "You can always update to a newer version. But you can never downgrade to a more stable version." : "Vous pouvez à tout moment mettre à jour votre instance xD Drive vers une version plus récente. Vous ne pourrez cependant jamais revenir à une version antérieure en sélectionnant un canal plus stable.",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available." : "<strong>Toutes</strong> les applications ont une version compatible avec cette version de xD Drive.",
    "View changelog" : "Voir le journal des modifications",
    "Enterprise" : "Entreprise",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately. That update happens once xD Drive GmbH has done additional hardening and testing for large-scale and mission-critical deployments. This channel is only available to customers and provides the xD Drive Enterprise package." : "Pour les entreprises. Fournit toujours le correctif le plus récent, mais ne mettra pas à jour dans la version majeure suivante immédiatement. Cette mise à jour sera effectuée une fois que xD Drive GmbH aura effectué les renforcements et tests pour permettre un déploiement en production et à grande échelle. Ce canal de mise à jour est seulement disponible pour les clients et fournit le paquet xD Drive Entreprise.",
    "Stable" : "Stable",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> application n'a pas de version compatible pour cette version de xD Drive disponible.","<strong>%n</strong> applications n'ont pas de version compatible pour cette version de xD Drive disponible.","<strong>%n</strong> applications n'ont pas de version compatible pour cette version de xD Drive disponible."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong></strong>Applications compatibles pour cette version de Nexctloud",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong>  application n'a pas de version compatible avec cette version disponible de xD Drive","<strong>%n</strong> applications n'ont pas de version compatible avec cette version disponible de xD Drive","<strong>%n</strong> applications n'ont pas de version compatible avec cette version disponible de xD Drive"]
},
