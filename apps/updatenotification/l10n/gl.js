OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Revise os ficheiros de rexistro de xD Drive e do servidor na busca de erros.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Amosa as notificacións de actualizacións para o Nexcloud e fornece o SSO para o actualizador.",
    "Update" : "Actualizar",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Todas</strong> as aplicacións teñen dispoñíbel unha versión compatible para esta versión de xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> aplicación non ten ningunha versión compatíbel dispoñíbel para esta versión de xD Drive","<strong>%n</strong> aplicacións non teñen ningunha versión compatíbel dispoñíbel para esta versión de xD Drive"]
},
