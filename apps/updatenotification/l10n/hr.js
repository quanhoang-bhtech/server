OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Provjerite zapise xD Drive i poslužitelja za moguće pogreške.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Prikazuje obavijesti o ažuriranju za xD Drive i pruža SSO za alat za ažuriranje.",
    "Update" : "Ažuriraj",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Sve</strong> aplikacije imaju inačicu koja je kompatibilna s ovom inačicom xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> aplikacija nema nijednu inačicu koja je kompatibilna s ovom inačicom xD Drive","<strong>%n</strong> aplikacije nemaju nijednu inačicu koja je kompatibilna s ovom inačicom xD Drive","<strong>%n</strong> aplikacija nema nijednu inačicu koja je kompatibilna s ovom inačicom xD Drive"]
},
