OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Ellenőrizze, hogy vannak-e hibák a xD Drive és a rendszer naplófájljaiban.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Megjeleníti a xD Drive frissítéseiről szóló értesítéseket és SSO hozzáférést nyújt a frissítésekhez.",
    "Update" : "Frissítés",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> alkalmazásnak nincs elérhető kompatibilis verziója ehhez a xD Drive verzióhoz.","<strong>%n</strong> alkalmazásnak nincs elérhető kompatibilis verziója ehhez a xD Drive verzióhoz."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Minden</strong> alkalmazás rendelkezik ezzel a xD Drive verzióval kompatibilis verzióval",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> alkalmazásnak nincs elérhető kompatibilis verziója ehhez a xD Drive verzióhoz","<strong>%n</strong> alkalmazásnak nincs elérhető kompatibilis verziója ehhez a xD Drive verzióhoz"]
},
