OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Controlla i file di log di xD Drive e del server alla ricerca di errori.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Visualizza le notifiche degli aggiornamenti per xD Drive e fornisce il SSO per lo strumento di aggiornamento.",
    "Update" : "Aggiorna",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> applicazione non ha una versione compatibile disponibile per questa versione di xD Drive.","<strong>%n</strong> applicazioni non hanno una versione compatibile disponibile per questa versione di xD Drive.","<strong>%n</strong> applicazioni non hanno una versione compatibile disponibile per questa versione di xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Tutte</strong> le applicazioni hanno una versione compatibile disponibile per questa versione di xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> applicazione non ha una versione compatibile disponibile per questa versione di xD Drive","<strong>%n</strong> applicazione non hanno una versione compatibile disponibile per questa versione di xD Drive","<strong>%n</strong> applicazione non hanno una versione compatibile disponibile per questa versione di xD Drive"]
},
