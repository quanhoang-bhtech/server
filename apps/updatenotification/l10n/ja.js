OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "xD Driveとサーバーログファイルでエラーがないか確認してください。",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "xD Driveの更新通知を表示し、アップデータのSSOを提供します。",
    "Update" : "更新",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong>アプリが、このxD Driveバージョンと互換性があるバージョンではありません。"],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>すべて</strong>のアプリが、このxD Driveのバージョンに対応しています。",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["アプリ<strong>%n</strong> には、このxD Driveに互換性のあるバージョンがありません。"]
},
"nplurals=1; plural=0;");
