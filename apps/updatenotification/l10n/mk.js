OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Проверете ги записите во Cloud-от и записите во серверот за грешките.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Прикажува известувања за ажурирање на xD Drive и овозможува SSO за надградувачот.",
    "Update" : "Ажурирај",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["1 апликација нема компатибилност со оваа веријза","<strong>%n</strong> апликации немаат компатибилност со оваа веријза"],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Сите</strong> апликации се компатибилни за оваа верзија",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> апликација нема компатибилност со оваа веријза","<strong>%n</strong> апликации немаат компатибилност со оваа веријза"]
},
