OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Controleer de xD Drive- en serverlogbestanden op fouten.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Toont updatemeldingen voor xD Drive en zorgt voor SSO voor de updater.",
    "Update" : "Update",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Alle</strong> apps hebben een compatibele versie voor deze xD Drive versie",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> app heeft geen compatibele versie voor deze xD Drive versie","<strong>%n</strong> apps hebben geen compatibele versie voor deze xD Drive versie"]
},
