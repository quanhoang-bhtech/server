OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Sprawdź pliki dziennika xD Drive i serwera pod kątem błędów.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Wyświetla powiadomienia o aktualizacji dla usługi xD Drive i udostępnia SSO dla aktualizatora.",
    "Update" : "Aktualizuj",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> aplikacja nie ma kompatybilnej wersji z tą wersją xD Drive.","<strong>%n</strong> aplikacje nie ma kompatybilnej wersji z tą wersją xD Drive.","<strong>%n</strong> aplikacji nie ma kompatybilnej wersji z tą wersją xD Drive.","<strong>%n</strong> aplikacji nie ma kompatybilnej wersji z tą wersją xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Wszystkie</strong> aplikacje mają dostępną wersję zgodną z tą wersją xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> aplikacja nie ma kompatybilnej wersji dla tej wersji xD Drive","<strong>%n</strong> aplikacje nie mają kompatybilnej wersji dla tej wersji xD Drive","<strong>%n</strong> aplikacji nie ma kompatybilnej wersji dla tej wersji xD Drive","<strong>%n</strong> aplikacji nie ma kompatybilnej wersji dla tej wersji xD Drive"]
},
