OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Проверьте наличие ошибок в файлах журналов xD Drive и сервера.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Показывает уведомления об обновлениях для xD Drive и обеспечивает систему обновления технологией единого входа (SSO).",
    "Update" : "Обновить",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available." : "<strong>Все</strong> приложения имеют версию, совместимую с этой версией xD Drive.",
    "View changelog" : "Просмотреть изменения",
    "Enterprise" : "Использование на предприятии (Enterprise)",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately. That update happens once xD Drive GmbH has done additional hardening and testing for large-scale and mission-critical deployments. This channel is only available to customers and provides the xD Drive Enterprise package." : "Для корпоративного использования. Всегда обеспечивает самый последний уровень исправлений, но не будет немедленно обновляться до следующего основного выпуска. Обновление произойдет, когда xD Drive GmbH проведут дополнительное тестирование для крупномасштабных и критически важных развертываний. Этот канал доступен только для клиентов и предоставляет пакет xD Drive Enterprise.",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["У <strong>%n</strong> приложения нет версии, совместимой с этой версией xD Drive.","У <strong>%n</strong> приложений нет версии, совместимой с этой версией xD Drive.","У <strong>%n</strong> приложений нет версии, совместимой с этой версией xD Drive.","У <strong>%n</strong> приложений нет версии, совместимой с этой версией xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Все</strong> приложения имеют версию, совместимую с этой версией xD Drive.",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["У <strong>%n</strong> приложения нет версии, совместимой с этой версией xD Drive.","У <strong>%n</strong> приложений нет версии, совместимой с этой версией xD Drive.","У <strong>%n</strong> приложений нет версии, совместимой с этой версией xD Drive.","У <strong>%n</strong> приложений нет версии, совместимой с этой версией xD Drive."]
},
