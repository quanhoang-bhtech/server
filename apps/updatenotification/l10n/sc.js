OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Controla is archìvios de registru de xD Drive e de su serbidore a sa chirca de is errores.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Visualiza is notìficas de is agiornamentos pro xD Drive e fruni su SSO pro sa funtzione de agiornamentu.",
    "Update" : "Agiorna",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Totu</strong> is aplicatziones tenent una versione cumpatìbile a disponimentu pro custa versione de xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong>aplicatziones no tenent una versione noa cumpatìbile a disponimentu pro custa versione de xD Drive ","<strong>%n</strong> "]
},
