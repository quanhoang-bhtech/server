OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Preverite strežniške in sistemske dnevnike za napake.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Pokaže obvestila o posodobitvah okolja xD Drive in omogoča prijavo SSO za posodabljalnik.",
    "Update" : "Posodobi",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Vsi</strong> nameščeni programi imajo pripravljene posodobitve, skladne s to različico okolja xD Drive.",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["S to različico okolja xD Drive ima potrjene skladne posodobitve <strong>%n</strong> nameščen program.","S to različico okolja xD Drive imata potrjene skladne posodobitve <strong>%n</strong> nameščena programa.","S to različico okolja xD Drive imajo potrjene skladne posodobitve <strong>%n</strong> nameščeni programi.","S to različico okolja xD Drive ima potrjene skladne posodobitve <strong>%n</strong> nameščenih programov."]
},
