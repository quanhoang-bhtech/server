OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Vänligen kontrollera ditt moln och dess serverloggar för felmeddelanden.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Visar uppdateringsaviseringar för xD Drive och tillhandahåller SSO för uppdateraren.",
    "Update" : "Uppdatera",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available." : "<strong>Alla</strong> appar har en kompatibel version för denna version av xD Drive.",
    "View changelog" : "Visa ändringslogg",
    "Enterprise" : "Enterprise",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately. That update happens once xD Drive GmbH has done additional hardening and testing for large-scale and mission-critical deployments. This channel is only available to customers and provides the xD Drive Enterprise package." : "Innehåller alltid den senaste patchnivån, men uppdateras inte omedelbart till nästa större version. Den uppdateringen sker när xD Drive GmbH har utfört ytterligare verifiering och testning för storskaliga och kritiska installationer. Den här kanalen är endast tillgänglig för kunder och tillhandahåller xD Drive Enterprise-paketet.",
    "Stable" : "Stabil",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> app har ingen tillgänglig kompatibel version för denna version av xD Drive.","<strong>%n</strong> appar har ingen tillgänglig kompatibel version för denna version av xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Alla</strong> appar har en kompatibel version för denna version av xD Drive.",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> app har ingen tillgänglig kompatibel version för denna version av xD Drive.","<strong>%n</strong> appar har ingen tillgänglig kompatibel version för denna version av xD Drive."]
},
