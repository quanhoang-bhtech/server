OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "Перегляньте журнал помилок xD Drive та сервера на наявність інформації про помилки.",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "Відображає сповіщення про оновлення для xD Drive і надає SSO для програми оновлення.",
    "Update" : "Оновлення",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> застосункок не сумісний з цією версією xD Drive.","<strong>%n</strong> застосунки не сумісні з цією версією xD Drive.","<strong>%n</strong> застосунків не сумісні з цією версією xD Drive.","<strong>%n</strong> застосунків не сумісні з цією версією xD Drive."],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>Усі</strong> програми мають сумісну версію для цієї версії xD Drive",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> застосунок не має сумісної версії для вашої версії xD Drive","<strong>%n</strong> застосунки не мають сумісної версії для вашої версії xD Drive","<strong>%n</strong> застосунків не мають сумісної версії для вашої версії xD Drive","<strong>%n</strong> застосунків не мають сумісної версії для вашої версії xD Drive"]
},
