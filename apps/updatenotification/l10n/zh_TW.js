OC.L10N.register(
    ...
    "Please check the xD Drive and server log files for errors." : "請檢查伺服器紀錄檔以確認錯誤。",
    ...
    "Displays update notifications for xD Drive and provides the SSO for the updater." : "顯示 xD Drive 的更新通知，並為更新程式提供 SSO。",
    "Update" : "更新",
    ...
    "<strong>All</strong> apps have a compatible version for this xD Drive version available." : "<strong>所有</strong>應用程式都有適用於此 xD Drive 版本的相容版本。",
    ...
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available._::_<strong>%n</strong> apps have no compatible version for this xD Drive version available._" : ["<strong>%n</strong> 應用程式沒有與此 xD Drive 版本相容的版本。"],
    "<strong>All</strong> apps have a compatible version for this xD Drive version available" : "<strong>所有</strong>應用程式都有適用於此 xD Drive 版本的相容版本",
    "_<strong>%n</strong> app has no compatible version for this xD Drive version available_::_<strong>%n</strong> apps have no compatible version for this xD Drive version available_" : ["<strong>%n</strong> 應用程式沒有與此 xD Drive 版本相容的版本"]
},
"nplurals=1; plural=0;");
