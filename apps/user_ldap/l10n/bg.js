OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "Това приложение позволява на администраторите да свържат xD Drive към потребителска директория, базирана на LDAP. ",
    "This application enables administrators to connect xD Drive to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into xD Drive from a directory with the appropriate queries and filters.\n\nA user logs into xD Drive with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. xD Drive does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then xD Drive uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation." : "Това приложение позволява на администраторите да свържат xD Drive към LDAP-базирана потребителска директория за удостоверяване и предоставяне на потребители, групи и потребителски атрибути. Администраторите могат да конфигурират това приложение да се свързва с една или повече LDAP директории или Active Directories/активни директории/, чрез LDAP интерфейс. Атрибути, като потребителска квота, имейл, снимки на аватар, членство в групи и други могат да бъдат изтеглени в xD Drive от директория със съответните заявки и филтри.\n\nПотребителя влиза в xD Drive със своите LDAP или AD идентификационни данни и му се предоставя достъп въз основа на заявка за удостоверяване, обработвана от LDAP или AD сървъра. xD Drive не съхранява LDAP или AD пароли, а тези идентификационни данни се използват за удостоверяване на потребител и след това xD Drive използва сесия за потребителския идентификатор. Повече информация е налична в документацията на LDAP потребител и групов сървър.",
