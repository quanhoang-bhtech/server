OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "Diese App ermöglicht es Administratoren xD Drive mit einem LDAP-basiertem Nutzerverzeichnis zu verbinden.",
