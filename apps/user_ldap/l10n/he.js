OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "יישומון זה מאפשר למנהלים להתחבר את xD Drive לספריית משתמשים מבוססת LDAP.",
