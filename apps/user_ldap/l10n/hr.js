OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "Ova aplikacija omogućuje administratorima da povežu xD Drive s korisničkim imenikom koji se temelji na LDAP-u.",
    "This application enables administrators to connect xD Drive to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into xD Drive from a directory with the appropriate queries and filters.\n\nA user logs into xD Drive with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. xD Drive does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then xD Drive uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation." : "Ova aplikacija omogućuje administratorima da povežu xD Drive s korisničkim imenikom koji se temelji na LDAP-u radi autentifikacije i upravljanja korisnicima, grupama i korisničkim atributima. Administratori mogu konfigurirati ovu aplikaciju za povezivanje s jednim ili više LDAP imenika ili aktivnih imenika putem sučelja LDAP-a. Atributi kao što su kvote, adrese e-pošte, profilne slike, članstva u grupi... mogu se povući u xD Drive iz imenika odgovarajućim upitima i filtrima.\n\nKorisnik se prijavljuje u xD Drive svojim LDAP ili AD vjerodajnicama, a pristup mu se odobrava na temelju zahtjeva za autentifikacijom kojim upravlja LDAP ili AD poslužitelj. xD Drive ne pohranjuje LDAP ili AD zaporke, već se te vjerodajnice koriste za autentifikaciju korisnika, a xD Drive koristi sesiju za ID korisnika. Više informacija dostupno je u dokumentaciji pozadinskog sustava LDAP-a za korisnike i grupe.",
