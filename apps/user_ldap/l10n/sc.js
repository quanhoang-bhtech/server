OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "Custa aplicatzione permitit a s'amministratzione de connètere xD Drive a una cartella de utentes basada in LDAP-",
    "This application enables administrators to connect xD Drive to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into xD Drive from a directory with the appropriate queries and filters.\n\nA user logs into xD Drive with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. xD Drive does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then xD Drive uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation." : "Custa aplicatzione permitit a s'amministratzione de connètere xD Drive a una cartella de utentes basada in LDAP, pro s'autenticatzione e sa creatzione de utentes, grupos e atributos de is utentes. S'amministratzione podet  cunfigurare cust'aplicatzione pro connètere una o prus cartellas LDAP o Active Directory tràmite un'interfache LDAP. Is atributos comente cuota de utente, posta eletrònica, immàgines de avatar, apartenèntzia a grupos e àteros podent èssere tramudados in xD Drive dae una cartella cun is rechestas e filtros adatos. \n\nUn'utente intrat in xD Drive cun is credentziales LDAP o AD suas, e tenet atzessu gràtzias a una rechesta de autenticatzione manigiada dae su serbidore LDAP o AD. xD Drive no allogat is craes LDAP o AD, ma custas credentziales sunt impreada pro autenticare un'utente e pustis xD Drive impreat una sessione pro s'ID de s'utente. Àteras informatziones sunt disponìbiles in sa documentatzione de su Motore Utente e Grupos LDAP.",
