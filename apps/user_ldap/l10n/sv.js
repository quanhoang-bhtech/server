OC.L10N.register(
    ...
    "This application enables administrators to connect xD Drive to an LDAP-based user directory." : "Den här applikationen gör det möjligt för administratörer att ansluta xD Drive till en LDAP-baserad användarkatalog.",
    "This application enables administrators to connect xD Drive to an LDAP-based user directory for authentication and provisioning users, groups and user attributes. Admins can configure this application to connect to one or more LDAP directories or Active Directories via an LDAP interface. Attributes such as user quota, email, avatar pictures, group memberships and more can be pulled into xD Drive from a directory with the appropriate queries and filters.\n\nA user logs into xD Drive with their LDAP or AD credentials, and is granted access based on an authentication request handled by the LDAP or AD server. xD Drive does not store LDAP or AD passwords, rather these credentials are used to authenticate a user and then xD Drive uses a session for the user ID. More information is available in the LDAP User and Group Backend documentation." : "Den här applikationen gör det möjligt för administratörer att ansluta xD Drive till en LDAP-baserad användarkatalog för autentisering och provisioning av användare, grupper och användarattribut. Admins kan konfigurera den här applikationen för att ansluta till en eller flera LDAP-kataloger eller AD via ett LDAP-gränssnitt. Attribut som användarkvot, e-post, avatarbilder, gruppmedlemskap och mer kan hämtas in till xD Drive från en katalog med relevanta frågor och filter.\n\nEn användare loggar in i xD Drive med sina LDAP- eller AD-referenser, och beviljas åtkomst baserat på en autentiseringsbegäran som hanteras av LDAP- eller AD-servern. xD Drive lagrar inte LDAP- eller AD-lösenord, utan dessa referenser används för att verifiera en användare och xD Drive använder en session för användar-ID. Mer information finns i dokumentationen för LDAP User and Group Backend.",
