...
class CoreNotifier implements INotifier {
	...
	public function getName(): string {
		return $this->l10nFactory->get('core')->t('xD Drive Server');
	}
	...
	public function prepare(INotification $notification, string $languageCode): INotification {
		...
		if ($notification->getSubject() === 'user_limit_reached') {
			...
			$notification->setParsedMessage($l->t('Enter your subscription key in the support app in order to increase the user limit. This does also grant you all additional benefits that xD Drive Enterprise offers and is highly recommended for the operation in companies.'));
