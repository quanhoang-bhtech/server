OC.L10N.register(
    ...
    "xD Drive Server" : "خادم نكست كلاود",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "فشل التحديث. يرجى التبليغ عن هذه المشكلة إلى <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\"> مجتمع xD Drive </a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "يبدو أنك تحاول إعادة تثبيت نكست كلاود الخاص بك. ومع ذلك ، فإن الملف CAN_INSTALL مفقود من دليل التثبيت الخاص بك. يرجى إنشاء الملف CAN_INSTALL في مجلد التثبيت الخاص بك للمتابعة.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "إصدار المجتمع هذا من xD Drive غير مدعوم والإشعارات الفورية غير متاحة.",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "أدخل مفتاح اشتراكك لزيادة حد المستخدم. لمزيد من المعلومات حول مشروع نكست كلاود، راجع موقعنا على الويب.",
