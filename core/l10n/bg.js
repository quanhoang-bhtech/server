OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Тази общностна версия на xD Drive не се поддържа и push известия са ограничени.",
    "Login" : "Вписване",
    ...
    "xD Drive Server" : "xD Drive сървър",
    ...
    "Enter your subscription key in the support app in order to increase the user limit. This does also grant you all additional benefits that xD Drive Enterprise offers and is highly recommended for the operation in companies." : "Въведете абонаментния си ключ в приложението за поддръжка, за да увеличите лимита на потребителите. Това ви дава и всички допълнителни предимства, които xD Drive Enterprise предлага, и е силно препоръчително за работа в компании.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Моля, уверете се, че сте задали опцията \"overwrite.cli.url\" във вашия файл config.php на URL адреса, който вашите потребители използват основно за достъп до този xD Drive. Предложение: „{suggestedOverwriteCliURL}“. В противен случай може да има проблеми с генерирането на URL чрез cron. (Възможно е обаче предложеният URL да не е URL адресът, който потребителите ви използват основно за достъп до този xD Drive. Най-добре е да проверите това отново за всеки случай.)",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Това е неподдържаната общностна версия на xD Drive. Като се има предвид размера на този екземпляр, производителността, надеждността и мащабируемостта не могат да бъдат гарантирани. Push известия са деактивирани, за да се избегне претоварването на нашата безплатна услуга. Научете повече за предимствата на xD Drive Enterprise на {linkstart}https://nextcloud.com/enterprise{linkend}.",
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "Конфигурацията на заглавката на обратния прокси сървър е неправилна или осъществявате достъп до xD Drive от доверен прокси сървър. Ако не, това е проблем със сигурността и може да позволи на хакер да прикрие IP адреса си в xD Drive. Допълнителна информация можете да намерите в {linkstart}документацията ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Изглежда, че използвате 32-битова PHP версия. Приложението xD Drive 26 и по-новите версии изискват 64-битова версия. Моля, обновете операционната си система и PHP на 64-битова версия! За повече подробности прочетете {linkstart}страницата с документация за това {linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Актуализирането беше неуспешно. Моля отнесете този проблем към <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\"> xD Drive общността</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Изглежда, че се опитвате да преинсталирате xD Drive. Файлът CAN_INSTALL обаче липсва във вашата конфигурационна директория. Моля, създайте файла CAN_INSTALL във вашата конфигурационна папка, за да продължите.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Тази общностна версия на xD Drive не се поддържа и незабавните известия не са налични.",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Въведете абонаментния си ключ, за да увеличите потребителския си лимит. За повече информация относно xD Drive Enterprise вижте нашия уеб сайт.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Проверяване на таблица %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Това е неподдържаната общностна версия на xD Drive. Като се има предвид размера на този екземпляр, производителността, надеждността и мащабируемостта не могат да бъдат гарантирани. Push известията са деактивирани, за да се избегне претоварването на нашата безплатна услуга. Научете повече за предимствата на xD Drive Enterprise на nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 е последното издание, поддържащо PHP 7.3. xD Drive 24 изисква поне PHP 7.4.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Изглежда, че използвате 32-битова PHP версия. Приложението xD Drive 26 и по-новите версии изискват 64-битова версия. Моля, обновете операционната си система и PHP на 64-битова версия! За повече подробности прочетете {linkstart}страницата с документация за това {linkend}."
},
