OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Aquesta versió de la comunitat de xD Drive no té suport i les notificacions push estan limitades.",
    ...
    "xD Drive Server" : "Servidor del xD Drive",
    ...
    "Enter your subscription key in the support app in order to increase the user limit. This does also grant you all additional benefits that xD Drive Enterprise offers and is highly recommended for the operation in companies." : "Introduïu la vostra clau de subscripció a l'aplicació d'assistència per augmentar el límit d'usuaris. Això també us atorga tots els avantatges addicionals que ofereix xD Drive Enterprise i és molt recomanable per al funcionament en empreses.",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Aquesta és la versió de comunitat no suportada de xD Drive. Donada la mida d'aquesta instància, no es pot garantir el rendiment, la fiabilitat i l'escalabilitat. Les notificacions push estan limitades per evitar sobrecarregar el nostre servei gratuït. Obteniu més informació sobre els avantatges de xD Drive Enterprise a {linkstart}https://nextcloud.com/enterprise{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Sembla que esteu executant una versió PHP de 32 bits. xD Drive 26 i superior requereixen 64 bits. Si us plau, actualitzeu el vostre sistema operatiu i PHP a 64 bits! Per més detalls, llegiu {linkstart}la pàgina de documentació ↗{linkend} sobre això.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "S'ha produït un error durant l'actualització. Informeu d'aquest error a la <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">comunitat del xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Sembla que estàs intentant reinstal·lar el teu xD Drive. Malgrat això manca el fitxer CAN_INSTALL al directori de configuració. Crea el fitxer CAN_INSTALL al teu directori de configuració per continuar.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Aquesta versió de la comunitat del xD Drive no és compatible i les notificacions instantànies no estan disponibles.",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Indiqueu la vostra clau de subscripció per a augmentar el límit d'usuaris. Per a obtenir més informació sobre el xD Drive Enterprise, consulteu el nostre lloc web.",
    "[%d / %d]: Checking table %s" : "[%d/%d]: S'està comprovant la taula %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Aquesta és la creació de comunitat no compatible de xD Drive. Donada la mida d'aquesta instància, no es pot garantir el rendiment, la fiabilitat i l'escalabilitat. Les notificacions push s'han inhabilitat per evitar sobrecarregar el nostre servei gratuït. Obteniu més informació sobre els avantatges de xD Drive Enterprise a nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 és l'última versió que admet PHP 7.3. xD Drive 24 requereix almenys PHP 7.4.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Sembla que esteu executant una versió PHP de 32 bits. xD Drive 26 i superior requereixen 64 bits. Si us plau, actualitzeu el vostre sistema operatiu i PHP a 64 bits! Per obtenir més detalls, llegiu {linkstart}la pàgina de documentació sobre això ↗{linkend}."
},
