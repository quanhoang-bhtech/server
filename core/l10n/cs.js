OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Toto komunitní vydání xD Drive není podporováno a push oznámení jsou proto omezená.",
    "Login" : "Přihlásit",
    ...
    "xD Drive Server" : "Server xD Drive",
    ...
    "Enter your subscription key in the support app in order to increase the user limit. This does also grant you all additional benefits that xD Drive Enterprise offers and is highly recommended for the operation in companies." : "Pokud chcete zvýšit limit počtu uživatelů, zadejte klíč svého předplatného. To vám zpřístupní také veškeré další přínosy, které xD Drive Enterprise poskytuje a je velmi doporučováno pro provozování ve firmách.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Zajistěte, aby volba „overwrite.cli.url„ v souboru config.php byla nastavena na URL adresu, přes kterou uživatelé přistupují k této instanci xD Drive. Doporučení: „{suggestedOverwriteCliURL}“. Pokud tomu tak nebude, může docházet k problémům při vytváření URL prostřednictvím plánovače cron. (ačkoli je možné, že doporučená URL není tou, kterou uživatelé zpravidla používají pro přístup k této instanci xD Drive. Nejlepší je toto v každém případě překontrolovat.)",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Toto je nepodporované komunitní sestavení xD Drive. Vzhledem k velikosti této instance, není garantován výkon, spolehlivost, ani škálovatelnost. Aby se zabránilo přetěžování našich služeb, které jsou zdarma, okamžitá oznámení byla omezena. Zjistěte více o výhodách xD Drive pro podniky na {linkstart}https://nextcloud.com/enterprise{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Zdá se, že provozujete 32bitovou verzi PHP. xD Drive verze 26 a novější vyžaduje 64bit. Přejděte na 64bit instalaci operačního systému a PHP! Bližší podrobnosti naleznete {linkstart}na stránce v dokumentaci ↗{linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Aktualizace nebyla úspěšná. Prosím nahlaste tento problém <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">komunitě projektu xD Drive</a>",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Zdá se, že se pokoušíte přeinstalovat svou instanci xD Drive. Nicméně ve vašem adresáři s nastaveními chybí soubor CAN_INSTALL. Aby bylo možné pokračovat, takový tam vytvořte.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Pokud chcete zvýšit limit počtu uživatelů, zadejte klíč předplatného. Další informace o xD Drive Enterprise najdete na našich webových stránkách.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Kontroluje se tabulka %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Toto je nepodporované komunitní sestavení xD Drive. Vzhledem k velikosti této instance, není garantován výkon, spolehlivost, ani škálovatelnost. Aby se zabránilo přetěžování našich služeb, které jsou zdarma, okamžitá oznámení byla vypnuta. Zjistěte více o výhodách xD Drive pro podniky na nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 je posledním vydáním, které podporuje PHP 7.3. xD Drive 24 vyžaduje přinejmenším PHP 7.4.",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "U některých sloupců tabulek databáze doposud nebyla provedena konverze na datový typ big int. To proto, že změna typů sloupců ve velkých tabulkách může trvat dlouho a proto nebylo provedeno automaticky. Provedení je možné spustit ručně a to spuštěním příkazu „occ db: convert-filecache-bigint“. Ovšem provést lze jen tehdy, když je instance Nexcloud odstavená. Další podrobnosti naleznete {linkstart}na stránce v dokumentaci, pojednávající o tomto↗{linkend}.",
    "To migrate to another database use the command line tool: 'occ db:convert-type', or see the {linkstart}documentation ↗{linkend}." : "Pokud chcete-li převést do jiné databáze, použijte nástroj pro příkazový řádek:  „occ db:convert-type“, nebo si projděte {linkstart}dokumentaci ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Zdá se, že provozujete 32bitovou verzi PHP. xD Drive verze 26 a novější vyžaduje 64bit. Přejděte na 64bit instalaci operačního systému a PHP! Bližší podrobnosti naleznete {linkstart}na stránce v dokumentaci ↗{linkend}."
},
