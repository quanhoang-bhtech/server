OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Diese Community-Version von xD Drive wird nicht unterstützt und (Push-)Benachrichtigungen sind nur begrenzt verfügbar.",
    "Login" : "Anmelden",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Bitte stelle sicher, dass du die Option „overwrite.cli.url“ in deiner config.php-Datei auf die URL setzt, die deine Benutzer hauptsächlich verwenden, um auf diese xD Drive zuzugreifen. Vorschlag: \"{suggestedOverwriteCliURL}\". Andernfalls kann es zu Problemen bei der URL-Generierung per Cron kommen. (Es ist jedoch möglich, dass die vorgeschlagene URL nicht die URL ist, die deine Benutzer hauptsächlich verwenden, um auf diese xD Drive zuzugreifen. Am besten überprüfst du dies in jedem Fall.)",
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "Die Reverse-Proxy-Header-Konfiguration ist fehlerhaft oder du greifst auf xD Drive über einen vertrauenswürdigen Proxy zu. Ist dies nicht der Fall, dann besteht ein Sicherheitsproblem, das einem Angreifer erlaubt, die IP-Adresse, die für xD Drive sichtbar ist, auszuspähen. Weitere Informationen hierzu finden sich in der {linkstart}Dokumentation ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Es scheint,  dass xD Drive mit einer 32-Bit-PHP-Version ausgeführt wird. xD Drive 26 und neuer benötigt die 64-Bit-Version. Bitte aktualisiere dein Betriebssystem und PHP auf 64-Bit. Für weitere Details lese die {linkstart}diesbezügliche Dokumentationsseite ↗{linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Das Update ist fehlgeschlagen. Bitte melde dieses Problem an die <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive Community</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Es sieht so aus, als ob du xD Drive erneut installieren möchtest. Es fehlt jedoch die Datei CAN_INSTALL in deinem Konfigurationsordner. Bitte erstelle die Datei CAN_INSTALL im Konfigurationsordner um fortzufahren.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Es scheint,  dass xD Drive mit einer 32-Bit-PHP-Version ausgeführt wird. xD Drive 26 und neuer benötigt die 64-Bit-Version. Bitte aktualisiere dein Betriebssystem und PHP auf 64-Bit. Für weitere Details lese die {linkstart}diesbezügliche Dokumentationsseite ↗{linkend}."
},
