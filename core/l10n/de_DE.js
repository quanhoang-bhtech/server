OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Diese Community-Version von xD Drive wird nicht unterstützt und sofortige Benachrichtigungen sind nur begrenzt verfügbar.",
    "Login" : "Anmelden",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Bitte stellen Sie sicher, dass Sie die Option „overwrite.cli.url“ in Ihrer config.php-Datei auf die URL setzen, die Ihre Benutzer hauptsächlich verwenden, um auf diese xD Drive zuzugreifen. Vorschlag: \"{suggestedOverwriteCliURL}\". Andernfalls kann es zu Problemen bei der URL-Generierung per Cron kommen. (Es ist jedoch möglich, dass die vorgeschlagene URL nicht die URL ist, die Ihre Benutzer hauptsächlich verwenden, um auf diese xD Drive zuzugreifen. Am besten überprüfen Sie dies in jedem Fall.)",
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "Die Reverse-Proxy-Header-Konfiguration ist fehlerhaft oder Sie greifen auf xD Drive über einen vertrauenswürdigen Proxy zu. Ist dies nicht der Fall, dann besteht ein Sicherheitsproblem, das einem Angreifer erlaubt die IP-Adresse, die für xD Drive sichtbar ist, auszuspähen. Weitere Informationen hierzu befindet sich in der {linkstart}Dokumentation ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Es scheint, als ob Sie eine 32-Bit-PHP-Version ausführen. xD Drive 26 und höher erfordert 64-Bit. Bitte aktualisieren Sie Ihr Betriebssystem und PHP auf 64-Bit! Für weitere Details lesen Sie dazu die {linkstart}Dokumentationsseite ↗{linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Das Update ist fehlgeschlagen. Bitte melden Sie dieses Problem an die <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive Community</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Es sieht so aus, als ob Sie xD Drive erneut installieren möchten. Es fehlt jedoch die Datei CAN_INSTALL in ihrem Konfigurationsordner. Bitte erstellen Sie die Datei CAN_INSTALL im Konfigurationsordner um fortzufahren.",
    ...
    "This page will refresh itself when the instance is available again." : "Diese Seite aktualisiert sich automatisch, sobald xD Drive wieder verfügbar ist.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Geben Sie Ihren Abonnementschlüssel ein, um die Benutzergrenze zu erhöhen. Weitere Informationen über xD Drive für Unternehmen (Enterprise) finden Sie auf unserer Webseite.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Überprüfe Tabelle %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Dies ist der nicht unterstützte Community-Build von xD Drive. Angesichts der Größe dieser Instanz können Leistung, Zuverlässigkeit und Skalierbarkeit nicht garantiert werden. Push-Benachrichtigungen wurden deaktiviert, um eine Überlastung unseres kostenlosen Dienstes zu vermeiden. Erfahren Sie mehr über die Vorteile von xD Drive Enterprise unter nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 ist die letzte Version, die PHP 7.3 unterstützt. xD Drive 24 erfordert mindestens PHP 7.4.",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "Bei einigen Spalten in der Datenbank fehlt eine Konvertierung in big int. Aufgrund der Tatsache, dass das Ändern von Spaltentypen bei großen Tabellen einige Zeit dauern kann, wurden sie nicht automatisch geändert. Durch Ausführen von \"occ db:convert-filecache-bigint\" können diese ausstehenden Änderungen manuell übernommen werden. Diese Operation muss ausgeführt werden, während die Instanz offline ist. Weitere Details finden Sie auf {linkstart}der zugehörigen Dokumentationsseite ↗{linkend}.",
    "To migrate to another database use the command line tool: 'occ db:convert-type', or see the {linkstart}documentation ↗{linkend}." : "Um zu einer anderen Datenbank zu migrieren, benutzen Sie bitte die Befehlszeile: 'occ db:convert-type', oder in die {linkstart}Dokumentation ↗{linkend} schauen.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Sie scheinen eine 32-Bit-PHP-Version auszuführen. xD Drive 26 und neuer benötigt 64-Bit. Bitte aktualisieren Sie Ihr Betriebssystem und PHP auf 64-Bit! Für weitere Details lesen Sie die {linkstart}diesbezügliche Dokumentationsseite ↗{linkend}."
},
