OC.L10N.register(
    ...
    "xD Drive Server" : "Διακομιστής xD Drive",
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "Η διαμόρφωση των reverse proxy headers είναι εσφαλμένη, ή έχετε πρόσβαση στο xD Drive από έναν αξιόπιστο/έμπιστο διαμεσολαβητή. Εάν όχι, αυτό είναι ένα ζήτημα ασφάλειας και μπορεί να επιτρέψει σε έναν κακόβουλο χρήστη να ξεγελάσει την διεύθυνση IP του ως ορατή στο xD Drive. Περισσότερες πληροφορίες μπορείτε να βρείτε στη {linkstart}τεκμηρίωση ↗{linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Μη επιτυχημένη ενημέρωση. Παρακαλούμε αναφέρετε αυτό το πρόβλημα στην <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">κοινότητα xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Φαίνεται ότι προσπαθείτε να επανεγκαταστήσετε το xD Drive. Ωστόσο, το αρχείο CAN_INSTALL λείπει από τον κατάλογο config. Δημιουργήστε το αρχείο CAN_INSTALL στο φάκελο config για να συνεχίσετε.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Εισάγετε το κλειδί συνδρομής σας για να αυξήσετε το όριο χρήστη. Για περισσότερες πληροφορίες σχετικά με το xD Drive Enterprise, ανατρέξτε στον ιστότοπό μας.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Έλεγχος πίνακα %s",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "Το xD Drive 23 είναι η τελευταία έκδοση που υποστηρίζει PHP 7.3. Το xD Drive 24 απαιτεί τουλάχιστον PHP 7.4.",
