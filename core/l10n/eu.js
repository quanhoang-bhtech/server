OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "xD Drive komunitate bertsio honek ez du laguntza-zerbitzurik eta push jakinarazpenak mugatuta daude.",
    "Login" : "Hasi saioa",
    ...
    "xD Drive Server" : "xD Drive zerbitzaria",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Mesedez, ziurtatu zure config.php fitxategiko \"overwrite.cli.url\" aukera ezartzen duzula zure erabiltzaileek nagusiki xD Drive honetara sartzeko erabiltzen duten URLan. Iradokizuna: \"{suggestedOverwriteCliURL}\". Bestela, URL-a sortzeko arazoak egon daitezke cron bidez. (Litekeena da iradokitako URLa ez izatea zure erabiltzaileek nagusiki xD Drive honetara atzitzeko erabiltzen duten URLa. Edonola ere, hau egiaztatzea da onena.)",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "32 biteko PHP bertsioa exekutatzen ari zarela dirudi. xD Drive 26k eta berriagoek 64 bitekoa behar dute. Mesedez, eguneratu zure OS eta PHPa 64 bitekora! Xehetasun gehiago lortzeko, irakurri honi buruzko {linkstart}dokumentazio orria {linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Eguneraketak huts egin du. Mesedez, jakinarazi arazoa <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive komunitateari</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Badirudi zure xD Drive berrinstalatu nahian ari zarela. Hala ere CAN_INSTALL fitxategia ez da aurkitzen zure config direktorioan. Mesedez sor ezazu CAN_INSTALL fitxategia zure config karpetan jarraitu ahal izateko.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Sartu zure harpidetza-gakoa erabiltzaile muga goratzeko. xD Drive Enterprise-ri buruzko informazio gehiagorako ikusi gure webgunea.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Taula egiaztatzen %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Hau laguntzarik gabeko xD Drive komunitate bertsioa da. Instantzia honen tamaina kontuan hartuz, ezin da errendimendua, fidagarritasuna eta eskalabilitatea ziurtatu. Push jakinarazpenak desgaitu egin dira gure doako zerbitzua ez gainkargatzeko. Ikusi xD Drive Enterprise buruzko abantailak nextcloud.com/enterprise orrian.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 da PHP 7.3 onartzen duen azken bertsioa. xD Drive 24 PHP 7.4 behar du gutxienez.",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "Datu baseko zutabe batzuek big int bihurtzea falta dute. Taula handietan zutabe motak aldatzeak denbora dezente har dezakeenez ez dira automatikoki aldatu. 'Occ db: convert-filecache-bigint' exekutatuz zain dauden aldaketak eskuz aplika litezke. Eragiketa hau instantzia lineaz kanpo dagoen bitartean egin behar da. Xehetasun gehiagorako, irakurri {linkstart} honi buruzko dokumentazio orria ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "32 biteko PHP bertsioa exekutatzen ari zarela dirudi. xD Drive 26k eta berriagoek 64 biteko behar dute. Mesedez, eguneratu zure OS eta PHPa 64 bitekora! Xehetasun gehiago lortzeko, irakurri {linkstart} honi buruzko dokumentazio orria ↗{linkend}."
},
