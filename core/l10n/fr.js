OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Cette version communautaire de xD Drive n'est pas prise en charge et les notifications push sont limitées.",
    "Login" : "S'identifier",
    ...
    "xD Drive Server" : "Serveur xD Drive",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Veillez à définir le paramètre \"overwrite.cli.url\" dans votre fichier config.php avec l'URL que vos utilisateurs utilisent principalement pour accéder à ce xD Drive. Suggestion : \"{suggestedOverwriteCliURL}\". Sinon, il pourrait y avoir des problèmes avec la génération des URL via cron. (Il est toutefois possible que l'URL suggérée ne soit pas l'URL que vos utilisateurs utilisent principalement pour accéder à ce xD Drive. Le mieux est de le vérifier deux fois dans tous les cas).",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Ceci est la version communautaire non prise en charge de xD Drive. Compte tenu de la taille de cette instance, la performance, la fiabilité et la scalabilité ne peuvent être garanties. Les notifications push sont limitées pour éviter de surcharger notre service gratuit. Apprenez-en davantage sur les bénéfices de la version 'xD Drive Entreprise' sur {linkstart}https://nextcloud.com/enterprise{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Il semble que vous exécutez une version 32-bit de PHP. xD Drive 26 et plus nécessitent 64-bit. Veuillez mettre à jour votre système d'exploitation et PHP en 64 bits ! Pour plus de détails, lisez {linkstart}la page de documentation ↗{linkend} à ce sujet.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "La mise à jour a échoué. Veuillez reporter le problème à la <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">communauté xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "On dirait que vous essayez de réinstaller votre xD Drive. Toutefois, le fichier CAN_INSTALL est absent de votre répertoire de configuration. Veuillez créer le fichier CAN_INSTALL dans votre dossier de configuration pour continuer.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Cette version communautaire de xD Drive n'est pas prise en charge et les notifications push ne sont pas disponibles.",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Entrez votre clé d’abonnement pour augmenter la limite par utilisateur. Pour plus d'informations sur xD Drive Enterprise, consultez notre site web.",
    "[%d / %d]: Checking table %s" : "[%d / %d] : Vérification de la table %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Il s'agit de la version communautaire non prise en charge de xD Drive. Compte tenu de la taille de cette instance, les performances, la fiabilité et l'extensibilité ne peuvent être garanties. Les notifications push ont été désactivées pour éviter de surcharger notre service gratuit. Apprenez-en plus sur les avantages de xD Drive Enterprise sur nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 est la dernière version prenant en charge PHP 7.3. xD Drive 24 nécessite au moins PHP 7.4.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Il semble que vous exécutez une version 32-bit de PHP. xD Drive 26 et plus nécessitent 64-bit. Veuillez mettre à jour votre système d'exploitation et PHP en 64 bits ! Pour plus de détails, lisez {linkstart}la page de documentation à ce sujet ↗{linkend}."
},
