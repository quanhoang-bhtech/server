OC.L10N.register(
    ...
    "xD Drive Server" : "Servidor do xD Drive",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Fallou a actualización. Informe desta incidencia na <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">comunidade de xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Semella que está tentando reinstalar o seu xD Drive. Non obstante o ficheiro CAN_INSTALL falta no seu directorio de configuración. Cree o ficheiro CAN_INSTALL no cartafol de configuración para continuar.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Introduza a súa clave de subscrición para aumentar o límite de usuarios. Para obter máis información sobre xD Drive Enterprise, consulte o noso sitio web.",
