OC.L10N.register(
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Assicurati di impostare l'opzione \"overwrite.cli.url\" nel tuo file config.php all'URL che i tuoi utenti usano abitualmente per accedere a questo xD Drive. Consiglio: \"{suggestedOverwriteCliURL}\". Altrimenti potrebbero esserci problemi con la generazione dell'URL via cron. (È possibile comunque che l'URL consigliato non sia l'URL che i tuoi utenti usano abitualmente per accedere a questo xD Drive. È meglio controllarlo due volte in ogni caso.)",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "L'aggiornamento non è riuscito. Segnala il problema alla <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">comunità di xD Drive </a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Sembra che tu stia tentando di reinstallare il tuo xD Drive. Tuttavia, manca il file CAN_INSTALL dalla cartella config. Crea il file CAN_INSTALL nella cartella config per continuare.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Digita la tua chiave di sottoscrizione per aumentare il limite di utenti. Per ulteriori informazioni su xD Drive Enterprise, visita il nostro sito web.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: controllo della tabella %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Questa è la build della community di xD Drive non supportata. Data la dimensione di questa istanza, non possono essere garantite le prestazioni, l'affidabilità e la scalabilità. Le notifiche push sono state disattivate per evitare di sovraccaricare il nostro servizio gratuito. Maggiori informazioni sui vantaggi di xD Drive Enterprise su nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 è l'ultima versione che supporta PHP 7.3. xD Drive 24 richiede almeno PHP 7.4.",
