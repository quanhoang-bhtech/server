OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "コミュニティリリースのxD Driveにサポートはなく、プッシュ通知には制限があります",
    "Login" : "ログイン",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "config.phpファイルの \"overwrite.cli.url \"オプションに、ユーザーが主にこのxD Driveにアクセスするために使用するURLを設定しておいてください。提案します。\"{suggestedOverwriteCliURL}\"を指定してください。そうしないと、cronによるURLの生成に問題が発生する可能性があります。(ただし、提案されたURLは、あなたのユーザーが主にこの xD DriveにアクセスするためのURLではない可能性があります。いずれにせよ、ダブルチェックするのがベストです)。",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "xD Driveを再インストールしようとしているようです。 しかし、CAN_INSTALLファイルがconfigディレクトリにありません。 続行するには、configフォルダーにCAN_INSTALLファイルを作成してください。",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "このサーバーはxD Driveの未サポートのコミュニティビルドです。このインスタンスのサイズでは、パフォーマンス、信頼性、スケーラビリティは保証されません。サービスに負荷をかけないように、プッシュ通知は無効になっています。xD Drive Enterpriseのメリットについては、nextcloud.com/enterprise をご覧ください。",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23は、PHP7.3をサポートする最後のリリースです。 xD Drive24には少なくともPHP7.4が必要です。",
