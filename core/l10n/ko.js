OC.L10N.register(
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "xD Drive를 다시 설치하려고 하는 것 같습니다. 그러나 현재 설정 디렉터리에 CAN_INSTALL 파일이 없는 것 같습니다. 계속 진행하려면 설정 폴더에 CAN_INSTALL 폴더를 만드십시오.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "사용자수 제한을 해제하기 위해 구독키를 입력하세요. 기업용 xD Drive에 대해 자세히 알고 싶다면, 저희 웹사이트를 방문하세요.",
