OC.L10N.register(
    ...
    "xD Drive Server" : "ເຊີບເວີ ເນັກຄຮາວ",
    ...
    "Your web server is not properly set up to deliver .woff2 files. This is typically an issue with the Nginx configuration. For xD Drive 15 it needs an adjustement to also deliver .woff2 files. Compare your Nginx configuration to the recommended configuration in our {linkstart}documentation ↗{linkend}." : "ເວັບ ໄຊຂອງທ່ານບໍ່ໄດ້ ຕິດຕັ້ງຢ່າງຖືກຕ້ອງເພື່ອສົ່ງຟາຍ ໌.woff2 . ໂດຍປົກກະຕິແລ້ວແມ່ນບັນຫາທີ່ມີການຕັ້ງຄ່າ Nginx. ສໍາລັບ xD Drive 15 ມັນຈໍາເປັນຕ້ອງມີການປັບຕົວເພື່ອສົ່ງຟາຍ .woff2 ອີກດ້ວຍ. ປຽບທຽບການຕັ້ງຄ່າ Nginx ຂອງທ່ານກັບການຕັ້ງຄ່າທີ່ ແນະນໍາໃນເອກະສານ {linkstart} ຂອງພວກເຮົາ ↗{linkend}.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "ການປັບປຸງບໍ່ສໍາເລັດ. ກະລຸນາລາຍງານບັນຫານີ້ຕໍ່ <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive.</a>",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "ເບິ່ງຄືວ່າທ່ານກໍາລັງພະຍາຍາມຕິດຕັ້ງ xD Drive ຂອງທ່ານຄືນໃຫມ່. ເຖິງ ຢ່າງ ໃດ ກໍ ຕາມ CAN_INSTALLຟາຍ ແມ່ນຂາດໄປຈາກບັນ ຊີການconfig ຂອງ ທ່ານ . ກະລຸນາສ້າງຟາຍ CAN_INSTALL ໃນໂຟນເດີ config ຂອງທ່ານເພື່ອສືບຕໍ່.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "ໃສ່ລະຫັດຜ່ານສະໝັກ ເພື່ອເພີ່ມຂີດຄວາມສາມາດຂອງຜູ້ໃຊ້. ສຳລັບຂໍ້ມູນເພີ່ມເຕີມກ່ຽວກັບ xD Drive ສາມາດເບິ່ງເວັບໄຊທ໌ຂອງພວກເຮົາ.",
