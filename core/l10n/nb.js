OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Denne fellesskapsutgaven av xD Drive støttes ikke og push-varslinger er begrenset.",
    "Login" : "Logg inn",
    ...
    "Your web server is not properly set up to deliver .woff2 files. This is typically an issue with the Nginx configuration. For xD Drive 15 it needs an adjustement to also deliver .woff2 files. Compare your Nginx configuration to the recommended configuration in our {linkstart}documentation ↗{linkend}." : "Nettserveren din er ikke riktig konfigurert til å levere .woff2-filer. Dette er vanligvis et problem med Nginx-konfigurasjonen. For xD Drive 15 trenger den en justering for også å levere .woff2-filer. Sammenlign Nginx-konfigurasjonen din med den anbefalte konfigurasjonen i {linkstart}dokumentasjonen ↗{linkend}.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Sørg for å sette \"overwrite.cli.url\"-alternativet i config.php-filen til URL-en som brukerne dine hovedsakelig bruker for å få tilgang til denne xD Drive. Forslag: \"{suggestedOverwriteCliURL}\". Ellers kan det være problemer med URL-generering via cron. (Det er imidlertid mulig at den foreslåtte URL-adressen ikke er URL-en som brukerne dine hovedsakelig bruker for å få tilgang til denne xD Drive. Det beste er å dobbeltsjekke dette i alle fall.)",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Oppdateringen mislyktes. Rapporter dette problemet til <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive-gemenskapen</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Det ser ut som at du forsøker å re installere xD Drive. Filen CAN_INSTALL mangler imidlertid fra innstillingsmappen. Opprett filen CAN_INSTALL i innstillingsmappen for å fortsette.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Denne community-utgaven av xD Drive er ikke understøttet og umiddelbare varsler er derfor ikke tilgjengelig. ",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Angi din abonnementsnøkkel for å øke brukergrensen. For mer informasjon om xD Drive Enterprise kan du besøke hjemmesiden vår.",
    ...
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 er den siste utgivelsen som støtter PHP 7.3. xD Drive 24 krever minst PHP 7.4.",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "Noen kolonner i databasen mangler en konvertering til big int. På grunn av det faktum at endring av kolonnetyper på store tabeller kunne ta litt tid ble de ikke endret automatisk. Ved å kjøre 'occ db:convert-filecache-bigint' kan de ventende endringene brukes manuelt. Denne operasjonen må utføres mens forekomsten er frakoblet. For ytterligere detaljer, les {linkstart}dokumentasjonssiden om dette ↗{linkend}.",
    "To migrate to another database use the command line tool: 'occ db:convert-type', or see the {linkstart}documentation ↗{linkend}." : "For å migrere til en annen database, bruk kommandolinjeverktøyet: 'occ db:convert-type', eller se {linkstart}dokumentasjonen ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Det virker som du kjører en 32-biters PHP-versjon. xD Drive 26 og høyere krever 64-bit. Vennligst oppgrader OS og PHP til 64-bit! For ytterligere detaljer, les {linkstart}dokumentasjonssiden om dette ↗{linkend}."
},
