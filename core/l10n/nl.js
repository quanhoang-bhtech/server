OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Deze community release van xD Drive wordt niet ondersteund en meldingen zijn beperkt",
    "Login" : "Inloggen",
    ...
    "Your web server is not properly set up to deliver .woff2 files. This is typically an issue with the Nginx configuration. For xD Drive 15 it needs an adjustement to also deliver .woff2 files. Compare your Nginx configuration to the recommended configuration in our {linkstart}documentation ↗{linkend}." : "Je webserver is niet goed ingesteld om .woff2 bestanden af te leveren. Dit is meestal een probleem met de Nginx configuratie. Voor xD Drive 15 moet die worden aangepast om ook .woff2 bestanden aan te kunnen. vergelijk jouw Nginx configuratie met de aanbevolen instellingen in onze {linkstart}documentatie ↗{linkend}.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Zorg ervoor dat de optie \"overwrite.cli.url\" in het config.php-bestand is ingesteld op de URL die je gebruikers voornamelijk gebruiken om toegang te krijgen tot deze xD Drive. Suggestie: \"{suggestedOverwriteCliURL}\". Anders kunnen er problemen zijn met het genereren van URL's via cron. (Het is echter mogelijk dat de voorgestelde URL niet de URL is die je gebruikers voornamelijk gebruiken om toegang te krijgen tot deze xD Drive. Het beste is om dit in ieder geval dubbel te controleren.)",
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "De reverse proxy headerconfiguratie is onjuist, of je hebt toegang tot xD Drive via een vertrouwde proxy. Als je xD Drive niet via een vertrouwde proxy benadert, dan levert dat een beveiligingsrisico op, waardoor een aanvaller het IP-adres dat xD Drive ziet kan vervalsen. Meer informatie is te vinden in onze  {linkstart}documentatie ↗{linkend}..",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "De update is mislukt. Meld dit probleem aan de <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Het lijkt erop of je xD Drive wilt herinstalleren. Maar het bestand CAN_INSTALL ontbreekt in de configdirectory. Maak het bestand CAN_INSTALL aan in je config map om verder te gaan.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Voer je abonnementssleutel in om de gebruikerslimiet te verhogen. Zie onze website voor meer informatie over xD Drive Enterprise.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Tabel controleren %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Dit is de niet-ondersteunde community build van xD Drive. Gegeven de grootte van deze instantie kunnen prestaties, betrouwbaarheid en schaalbaarheid niet worden gegarandeerd. Push meldingen zijn uitgeschakeld om te voorkomen dat onze gratis service wordt overbelast. Lees meer over de voordelen van xD Drive Enterprise op nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 is de laatste release die PHP 7.3 ondersteund. xD Drive 24 vereist minstens PHP 7.4.",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "Sommige kolommen in de database zijn niet geconverteerd naar 'big int'. Doordat het wijzigen van kolomtype op grote databases veel tijd kost, zijn ze niet automatisch gewijzigd. Door het uitvoeren van 'occ db:convert-filecache-bigint' worden de veranderingen alsnog uitgevoerd. Dat moet gebeuren als de server off-line staat. Voor meer informatie verwijzen we naar {linkstart}de documentatie hierover ↗{linkend}.",
    "To migrate to another database use the command line tool: 'occ db:convert-type', or see the {linkstart}documentation ↗{linkend}." : "Om te migreren naar een andere database moet u de commandoregel tool gebruiken: 'occ db:convert-type', of lees de {linkstart} documentatie  ↗{linkend}.",
