OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "To wydanie społecznościowe xD Drive nie jest obsługiwane, a powiadomienia Push są ograniczone.",
    "Login" : "Zaloguj",
    ...
    "xD Drive Server" : "Serwer xD Drive",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Upewnij się, że ustawiłeś opcję \"overwrite.cli.url\" w pliku config.php na adres URL, którego użytkownicy używają głównie do uzyskiwania dostępu do tej usługi xD Drive. Sugestia: \"{suggestedOverwriteCliURL}\". W przeciwnym razie mogą wystąpić problemy z generowaniem adresu URL przez cron. (Możliwe jest, że sugerowany adres URL nie jest adresem URL, którego użytkownicy używają głównie do uzyskiwania dostępu do tej usługi xD Drive. Najlepiej w każdym przypadku jest to sprawdzić.)",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Wygląda na to, że korzystasz z 32-bitowej wersji PHP. xD Drive 26 i nowsze wymagają wersji 64-bitowej. Zaktualizuj swój system operacyjny i PHP do wersji 64-bitowej! Aby uzyskać więcej informacji, przeczytaj {linkstart}stronę dokumentacji ↗{linkend} na ten temat.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Aktualizacja nie powiodła się. Zgłoś ten problem do <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">społeczności xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Wygląda na to, że próbujesz ponownie zainstalować xD Drive. Brakuje jednak pliku CAN_INSTALL w katalogu konfiguracyjnym. Aby kontynuować, utwórz plik CAN_INSTALL w katalogu konfiguracyjnym.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Wprowadź klucz subskrypcji, aby zwiększyć limit użytkowników. Więcej informacji o xD Drive dla firm można znaleźć na naszej stronie internetowej.",
    "[%d / %d]: Checking table %s" : "[%d/%d]: Sprawdzanie tabeli %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "To jest nieobsługiwana przez społeczność kompilacja xD Drive. Biorąc pod uwagę rozmiar tego wystąpienia, nie można zagwarantować wydajności, niezawodności i skalowalności. Powiadomienia Push zostały wyłączone, aby uniknąć przeciążenia naszej bezpłatnej usługi. Dowiedz się więcej o zaletach usługi xD Drive dla firm na stronie nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 to ostatnie wydanie obsługujące PHP 7.3. xD Drive 24 wymaga co najmniej PHP 7.4.",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "Niektóre kolumny w bazie danych nie zawierają konwersji do big integers. Ze względu na to, że zmiana typów kolumn w dużych tabelach może zająć dużo czasu, nie zostały one zmienione automatycznie. Oczekujące zmiany można wykonać ręcznie, uruchamiając 'occ db:convert-filecache-bigint'. Ta operacja musi zostać wykonana, gdy instancja jest w trybie offline. Więcej informacji na ten temat przeczytasz na {linkstart}stronie dokumentacji ↗{linkend}.",
    "To migrate to another database use the command line tool: 'occ db:convert-type', or see the {linkstart}documentation ↗{linkend}." : "Aby przeprowadzić migrację do innej bazy danych, użyj narzędzia wiersza poleceń: 'occ db:convert-type' lub zapoznaj się z {linkstart}dokumentacją ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Wygląda na to, że korzystasz z 32-bitowej wersji PHP. xD Drive 26 i nowsze wymagają wersji 64-bitowej. Zaktualizuj swój system operacyjny i PHP do wersji 64-bitowej! Aby uzyskać więcej informacji, przeczytaj {linkstart}stronę dokumentacji na ten temat ↗{linkend}."
},
