OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Esta versão da comunidade do xD Drive não é compatível e as notificações por push são limitadas.",
    "Login" : "Entrar",
    ...
    "xD Drive Server" : "Servidor xD Drive",
    ...
    "Your web server is not properly set up to deliver .woff2 files. This is typically an issue with the Nginx configuration. For xD Drive 15 it needs an adjustement to also deliver .woff2 files. Compare your Nginx configuration to the recommended configuration in our {linkstart}documentation ↗{linkend}." : "Seu servidor da web não está configurado corretamente para entregar arquivos .woff2. Normalmente, esse é um problema com a configuração do Nginx. Para o xD Drive 15, é necessário um ajuste para entregar também arquivos .woff2. Compare sua configuração Nginx com a configuração recomendada em nossa {linkstart}documentação ↗{linkend}.",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Esta é a compilação da comunidade sem suporte do xD Drive. Dado o tamanho desta instância, o desempenho, a confiabilidade e a escalabilidade não podem ser garantidos. As notificações push são limitadas para evitar sobrecarregar nosso serviço gratuito. Saiba mais sobre os benefícios do xD Drive Enterprise em {linkstart}https://nextcloud.com/enterprise{linkend}.",
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "A configuração do cabeçalho do proxy reverso está incorreta ou você está acessando o xD Drive de um proxy confiável. Caso contrário, este é um problema de segurança e pode permitir que um invasor falsifique seu endereço IP como visível para o xD Drive. Mais informações podem ser encontradas na {linkstart}documentação ↗{linkend}. ",
    ...
    "This instance uses an S3 based object store as primary storage. The uploaded files are stored temporarily on the server and thus it is recommended to have 50 GB of free space available in the temp directory of PHP. Check the logs for full details about the path and the available space. To improve this please change the temporary directory in the php.ini or make more space available in that path." : "Este xD Drive usa um armazenamento de objeto baseado no S3 como armazenamento primário. Os arquivos enviados são armazenados temporariamente no servidor e portanto é recomendado ter 50 GB de espaço livre disponível no diretório temp do PHP. Verifique os logs para obter detalhes completos sobre o caminho e o espaço disponível. Para melhorar isso, altere o diretório temporário no arquivo php.ini ou disponibilize mais espaço nesse caminho.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "A atualização não foi realizada com sucesso. Por favor, informe este problema para  a <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">comunidade xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Parece que você está tentando reinstalar o xD Drive. No entanto, o arquivo CAN_INSTALL está faltando no diretório de configuração. Crie o arquivo CAN_INSTALL na pasta de configuração para continuar.",
    ...
    "This page will refresh itself when the instance is available again." : "Esta página será atualizada quando o xD Drive estiver disponível novamente.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Digite sua chave de assinatura para aumentar o limite de usuários. Para obter mais informações sobre o xD Drive Enterprise, consulte nosso website.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Verificando tabela %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Este é a construção de uma comunidade sem suporte do xD Drive. Dado o tamanho desta instância, desempenho, confiabilidade e escalabilidade não podem ser garantidos. As notificações push foram desativadas para evitar sobrecarregar nosso serviço gratuito. Saiba mais sobre os benefícios do xD Drive Enterprise em nextcloud.com/enterprise. ",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 é a última versão compatível com PHP 7.3. xD Drive 24 requer pelo menos PHP 7.4. ",
