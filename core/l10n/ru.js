OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Используется сборка xD Drive для сообщества. Данная сборка не поддерживается и имеет ограниченный функционал push-уведомлений.",
    "Login" : "Войти",
    ...
    "xD Drive Server" : "Сервер xD Drive",
    ...
    "Enter your subscription key in the support app in order to increase the user limit. This does also grant you all additional benefits that xD Drive Enterprise offers and is highly recommended for the operation in companies." : "Для увеличения лимита пользователей введите код подписки в приложении «Поддержка». Оформление подписки рекомендуется при использовании Nexcloud в бизнесе, а также позволяет получить дополнительные преимущества, предлагаемые xD Drive для корпоративных пользователей.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Пожалуйста, не забудьте установить опцию \"overwrite.cli.url\" в вашем config.php с указанием URL-адреса, который ваши пользователи в основном используют для доступа к этому xD Drive. Предложение: \"{suggestedOverwriteCliURL}\". В противном случае могут возникнуть проблемы с генерацией URL-адреса через cron. (Однако возможно, что предлагаемый URL-адрес не является тем URL-адресом, который ваши пользователи в основном используют для доступа к этому xD Drive. В любом случае лучше всего перепроверить это дважды.)",
    "Your installation has no default phone region set. This is required to validate phone numbers in the profile settings without a country code. To allow numbers without a country code, please add \"default_phone_region\" with the respective {linkstart}ISO 3166-1 code ↗{linkend} of the region to your config file." : "Не указан регион размещения этого сервера xD Drive, что требуется для возможности проверки номеров телефонов без указания кода страны. Чтобы разрешить пользователям сервера указывать номера телефонов без указания кода страны, добавьте параметр «default_phone_region» с соответствующим кодом страны в соответствии с  {linkstart}ISO 3166-1↗{linkend}.",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Используется сборка для сообщества xD Drive, которая не имеет официальной поддержки. Размер этого развёртывания не позволяет гарантировать производительность, надёжность и масштабируемость. Функционал push-уведомлений ограничен, чтобы не перегружать бесплатный сервис разработчиков xD Drive. Узнайте больше о преимуществах корпоративной версии xD Drive на сайте {linkstart}https://nextcloud.com/enterprise{linkend}.",
    ...
    "The reverse proxy header configuration is incorrect, or you are accessing xD Drive from a trusted proxy. If not, this is a security issue and can allow an attacker to spoof their IP address as visible to the xD Drive. Further information can be found in the {linkstart}documentation ↗{linkend}." : "Заголовки обратного прокси настроены неправильно, либо подключение к серверу xD Drive осуществляется через доверенный прокси. Если xD Drive открыт не через доверенный прокси, то это проблема безопасности, которая может позволить атакующему подделать IP-адрес, определяемый сервером xD Drive. Дополнительная информация представлена в {linkstart}документации ↗{linkend}.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Похоже, что используется 32-битная версия PHP. Для  работы xD Drive начиная с версии 26 требуется 64-битная версия. Обновите  операционную систему и PHP до 64-битных версий. Для дополнительной информации {linkstart}обратитесь к документации ↗.{linkend}",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Обновление не удалось. Сообщите об этой проблеме <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">сообществу xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Похоже, вы пытаетесь переустановить xD Drive. Однако файл «CAN_INSTALL» отсутствует в вашем каталоге конфигурации. Чтобы продолжить создайте файл «CAN_INSTALL» в каталоге конфигурации.",
    ...
    "This community release of xD Drive is unsupported and instant notifications are unavailable." : "Эта сборка xD Drive для сообщества не обслуживается, мгновенные уведомления недоступны.",
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Введите ключ подписки, чтобы увеличить лимит пользователей. Для получения дополнительной информации о xD Drive Enterprise посетите наш веб-сайт.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Проверка таблицы %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Это неподдерживаемая сборка сообщества xD Drive. Размер этого развёртывания не позволяет,  гарантировать производительность, надежность и масштабируемость. Push-уведомления отключены, чтобы не перегружать бесплатный сервис разработчиков xD Drive. Узнайте больше о преимуществах корпоративной версии xD Drive на сайте nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 - это последний релиз, поддерживающий PHP 7.3. Для xD Drive 24 необходимо иметь минимальную версию PHP 7.4.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "Похоже, что используется 32-битная версия PHP. Для  работы xD Drive начиная с версии 26 требуется 64-битная версия. Обновите  операционную систему и PHP до 64-битных версий. Для дополнительной информации {linkstart}обратитесь к документации ↗.{linkend}"
},
