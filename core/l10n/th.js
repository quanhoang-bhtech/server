OC.L10N.register(
    ...
    "xD Drive Server" : "เซิร์ฟเวอร์ xD Drive",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "การอัปเดตไม่สำเร็จ กรุณารายงานปัญหานี้ไปยัง<a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">ชุมชน xD Drive</a>",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "ดูเหมือนว่าคุณกำลังพยายามติดตั้ง xD Drive ใหม่ แต่ในไดเรกทอรี config ของคุณไม่มีไฟล์ CAN_INSTALL โปรดสร้างไฟล์ CAN_INSTALL ในโฟลเดอร์ config ของคุณก่อนดำเนินการต่อ",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "ใส่รหัสการเป็นสมาชิกเพื่อเพิ่มขีดจำกัดจำนวนผู้ใช้ สำหรับข้อมูลเพิ่มเติมเกี่ยวกับ xD Drive Enterprise โปรดดูเว็บไซต์ของเรา",
