OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Bu xD Drive topluluk sürümü desteklenmiyor ve anlık bildirimler sınırlı şekilde kullanılabiliyor.",
    "Login" : "Oturum aç",
    ...
    "xD Drive Server" : "xD Drive sunucusu",
    ...
    "Enter your subscription key in the support app in order to increase the user limit. This does also grant you all additional benefits that xD Drive Enterprise offers and is highly recommended for the operation in companies." : "Kullanıcı sayısı sınırını artırmak için destek uygulamasına abonelik anahtarınızı yazın. Bu ayrıca size xD Drive Enterprise sürümünün sunduğu ve kurumsal operasyonlar için önemle önerilen tüm ek avantajları sağlar.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Lütfen config.php dosyanızdaki \"overwrite.cli.url\" seçeneğini, kullanıcılarınızın bu xD Drive kopyasına erişmek için kullandığı adres olarak ayarladığınızdan emin olun. Öneri: \"{suggestedOverwriteCliURL}\". Yoksa, cron üzerinden aders oluşturma sorunları çıkabilir. (Önerilen adres, kullanıcılarınızın bu xD Drive kopyasına erişmek için kullandığı adres olmasa da olabilir. Her durumda bunu iki kez denetlemek iyi olur.)",
    ...
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at {linkstart}https://nextcloud.com/enterprise{linkend}." : "Bu xD Drive topluluk sürümü desteklenmiyor. Bu kopyanın boyutu göz önüne alındığında, başarım, güvenilirlik ve ölçeklenebilirlik garanti edilemez. Ücretsiz hizmetimizi aşırı yüklememek için anında bildirimler sınırlandı. {linkstart}https://nextcloud.com/enterprise{linkend} adresinden xD Drive Enterprise sürümünün avantajları hakkında ayrıntılı bilgi alabilirsiniz.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "32 bit bir PHP sürümü çalıştırıyorsunuz gibi görünüyor. xD Drive 26 sürümü ve üzerinin iyi çalışması için 64 bit kullanılmalıdır. Lütfen işletim sisteminizi ve PHP sürümünüzü 64 bit olacak şekilde yükseltin! Ayrıntılı bilgi almak için {linkstart}ilgili belgeler sayfasına↗{linkend}  bakabilirsiniz.",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Uygulama güncellenemedi. Lütfen bu sorunu  <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive topluluğuna</a> bildirin.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "xD Drive kurulumunu yeniden yapmayı deniyorsunuz gibi görünüyor. Ancak config klasöründe CAN_INSTALL dosyası eksik. Lütfen İşlemi sürdürmek için config klasöründe CAN_INSTALL dosyasını oluşturun.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Kullanıcı sayısı sınırını arttırmak için abonelik anatarınızı yazın. xD Drive Enterprise sürümü hakkında ayrıntılı bilgi almak için web sitemize bakabilirsiniz.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: %s tablosu denetleniyor",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Bu xD Drive topluluk sürümü desteklenmiyor. Bu kopyanın boyutu göz önüne alındığında, başarım, güvenilirlik ve ölçeklenebilirlik garanti edilemez. Ücretsiz hizmetimizi aşırı yüklememek için anında bildirimler devre dışı bırakıldı. nextcloud.com/enterprise adresinden xD Drive Enterprise sürümünün avantajları hakkında ayrıntılı bilgi alabilirsiniz.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 PHP 7.3 sürümünü destekleyen son sürümdür. xD Drive 24 sürümü için en az PHP 7.4 gereklidir.",
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running 'occ db:convert-filecache-bigint' those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "Veritabanında büyük tamsayıya dönüştürülecek bazı sütunlar eksik. Sütun türlerini büyük tablolara dönüştürme işlemi uzun sürebileceğinden bu işlem otomatik olarak yapılmaz. Sunucunuz normal çalışırken bekleyen değişiklikleri el ile uygulamak için \"occ db:convert-filecache-bigint\" komutunu yürütün. Bu işlem yapılırken xD Drive kopyası çevrimdışı olur. Ayrıntılı bilgi almak için {linkstart}belgeler ↗{linkend} bölümüne bakabilirsiniz.",
    "To migrate to another database use the command line tool: 'occ db:convert-type', or see the {linkstart}documentation ↗{linkend}." : "Başka bir veritabanına geçmek için komut satırı aracını kullanın: 'occ db:convert-type' ya da {linkstart}belgeler ↗{linkend} bölümüne bakın.",
    ...
    "It seems like you are running a 32-bit PHP version. xD Drive 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page about this ↗{linkend}." : "32 bit bir PHP sürümü çalıştırıyorsunuz gibi görünüyor. xD Drive 26 sürümü ve üzerinin iyi çalışması için 64 bit kullanılmalıdır. Lütfen işletim sisteminizi ve PHP sürümünüzü 64 bit olacak şekilde yükseltin! Ayrıntılı bilgi almak için {linkstart}ilgili belgeler sayfasına bakabilirsiniz↗{linkend}."
},
