OC.L10N.register(
    ...
    "This community release of xD Drive is unsupported and push notifications are limited." : "Цей випуск спільноти xD Drive не підтримується, а push-сповіщення обмежені.",
    "Login" : "Логін",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this xD Drive. Suggestion: \"{suggestedOverwriteCliURL}\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this xD Drive. Best is to double check this in any case.)" : "Обов’язково встановіть параметр «overwrite.cli.url» у файлі config.php на URL-адресу, яку ваші користувачі в основному використовують для доступу до цього xD Drive. Пропозиція: \"{suggestedOverwriteCliURL}\". Інакше можуть виникнути проблеми з генерацією URL-адреси через cron. (Однак можливо, що запропонована URL-адреса не є URL-адресою, яку ваші користувачі в основному використовують для доступу до цього xD Drive. У будь-якому випадку найкраще ще раз перевірити це.)",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">xD Drive community</a>." : "Оновлення не вдалося. Будь ласка, повідомте про це питання в <a href=\"https://github.com/nextcloud/server/issues\" target=\"_blank\">спільноту xD Drive</a>.",
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "Схоже, ви намагаєтеся перевстановити xD Drive. Однак файл CAN_INSTALL відсутній у вашому каталозі конфігурації. Щоб продовжити, створіть файл CAN_INSTALL у папці конфігурації.",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "Введіть ключ підписки, щоб збільшити ліміт користувачів. Для отримання додаткової інформації про xD Drive Enterprise відвідайте наш веб-сайт.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Перевірка таблиці %s",
    "This is the unsupported community build of xD Drive. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of xD Drive Enterprise at nextcloud.com/enterprise." : "Це непідтримувана збірка спільноти xD Drive. Враховуючи розмір цього екземпляра, не можна гарантувати продуктивність, надійність і масштабованість. Push-сповіщення вимкнено, щоб уникнути перевантаження нашого безкоштовного сервісу. Дізнайтеся більше про переваги xD Drive Enterprise на nextcloud.com/enterprise.",
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 є останнім випуском, що підтримує PHP 7.3. xD Drive 24 вимагає принаймні PHP 7.4.",
