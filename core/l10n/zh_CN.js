OC.L10N.register(
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "看起来您正在尝试重新安装您的xD Drive。但您的config文件夹中没有CAN_INSTALL文件。请在您的config文件夹中创建CAN_INSTALL文件以继续。",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "输入订阅密钥以增加用户限制。欲了解更多关于xD Drive企业版的信息，请访问我们的网站。",
