OC.L10N.register(
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "您似乎正在嘗試重新安裝您的xD Drive。然而，檔案 CAN_INSTALL 並未在您的config目錄中。請在您的config目錄中建立 CAN_INSTALL檔以繼續。",
    ...
    "Enter your subscription key to increase the user limit. For more information about xD Drive Enterprise see our website." : "請輸入你獲得的訂閱代碼以解開用戶數量限制。有關xD Drive企業版的詳細信息請參見我們的網站。",
