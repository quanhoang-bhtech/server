OC.L10N.register(
    ...
    "It looks like you are trying to reinstall your xD Drive. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "您似乎正在嘗試重新安裝您的 xD Drive。然而，檔案 CAN_INSTALL 並不在您的 config 目錄中。請在您的 config 目錄中建立 CAN_INSTALL 檔以繼續。",
    ...
    "xD Drive 23 is the last release supporting PHP 7.3. xD Drive 24 requires at least PHP 7.4." : "xD Drive 23 將是支援 PHP 7.3 的最後一個版本，xD Drive 24 僅支援 PHP 7.4 以上的 PHP。",
