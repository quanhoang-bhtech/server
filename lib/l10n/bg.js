OC.L10N.register(
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "Регулирането на тази настройка в php.ini ще накара xD Drive да работи отново",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "Моля, помолете администратора на вашия сървър да провери конфигурацията на xD Drive.",
