OC.L10N.register(
    ...
    "It seems that this %s instance is running on a 32-bit PHP environment. 64-bit is required for 26 and higher." : "Zdá se, že tato instance %s je provozována v 32bitovém prostředí PHP. Pro xD Drive verze 26 a novější je zapotřebí 64bitového.",
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "Úprava tohoto nastavení v php.ini umožní xD Drive opět zprovoznit",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "Požádejte správce serveru, který využíváte, aby zkontroloval nastavení serveru.",
