OC.L10N.register(
    ...
    "It seems that this %s instance is running on a 32-bit PHP environment. 64-bit is required for 26 and higher." : "Diese %s-Instanz scheint auf einem 32 Bit PHP-System zu laufen. Ab xD Drive 26 sind 64 Bit erforderlich.",
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "Eine Änderung dieser Einstellung in der php.ini kann Ihre xD Drive wieder lauffähig machen.",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "Bitten Sie Ihre Server-Administration, die xD Drive-Konfiguration zu überprüfen.",
