OC.L10N.register(
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "Προσαρμόζοντας αυτήν τη ρύθμιση στο php.ini το xD Drive θα εκτελεστεί ξανά",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "Παρακαλούμε ζητήστε από το διαχειριστή του διακομιστή σας να ελέγξει τη διαμόρφωση του xD Drive.",
