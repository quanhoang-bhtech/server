OC.L10N.register(
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "php.ini のこの設定を調整して、再度 xD Driveを起動してください。",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "サーバー管理者にxD Drive構成を確認するように依頼してください。",
