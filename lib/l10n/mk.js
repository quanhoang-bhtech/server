OC.L10N.register(
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "Прилагодувањето на оваа поставка во php.ini ќе направи повторно да работи ",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "Замолете го сервер администраторот да ја провери конфигурацијата.",
