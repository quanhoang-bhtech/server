OC.L10N.register(
    ...
    "This can usually be fixed by giving the web server write access to the apps directory or disabling the App Store in the config file." : "Zwykle można to naprawić, przyznając serwerowi WWW dostęp do zapisu do katalogu aplikacji lub wyłączając xD Drive App Store w pliku konfiguracyjnym.",
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "Dostosowanie tego ustawienia w php.ini spowoduje ponowne uruchomienie xD Drive",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "Poproś administratora serwera o sprawdzenie konfiguracji xD Drive.",
