OC.L10N.register(
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "Налаштування цього параметра у php.ini змусить xD Drive запуститися знову",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "Будь ласка, попросіть свого адміністратора сервера перевірити конфігурацію xD Drive.",
