OC.L10N.register(
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "在 php.ini 中调整该设置将导致 xD Drive 重新运行",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "请联系您的服务器管理员检查 xD Drive 设置。",
