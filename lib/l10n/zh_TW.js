OC.L10N.register(
    ...
    "Adjusting this setting in php.ini will make xD Drive run again" : "調整 php.ini 中的設定，使 xD Drive 重新運作",
    ...
    "Please ask your server administrator to check the xD Drive configuration." : "請聯絡您的伺服器管理員檢查 xD Drive 設定。",
